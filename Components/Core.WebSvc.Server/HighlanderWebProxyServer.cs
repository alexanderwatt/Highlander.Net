...
namespace Highlander.Core.WebServer
{
    ...
    public class HighlanderWebProxyServer : ServerBase2, IWebProxyV101
    {
        ...
        //public HighlanderWebProxyServer(ILogger logger, EnvId env, int webPort, string serverAddress)
