...
namespace Highlander.NamedValueSet.DebuggerVisualizer
{
    ...
    {
        public NamedValueSetVisualizerForm(Utilities.NamedValues.NamedValueSet objectToVisualize)
        {
            InitializeComponent();
        ...
        private void PopulateUI(Utilities.NamedValues.NamedValueSet objectToVisualize)
        {
            //  populate text box
            //
            ...
            foreach (var nv in objectToVisualize.ToArray())
            {
                ...
                if (nv.IsArray())
                {
                    ...
                    foreach (var itemInArray in (Array)nv.Value)
                    {
                        ...
                        dataRow["NameColumn"] = $"{nv.Name}[{itemNumber}]";
