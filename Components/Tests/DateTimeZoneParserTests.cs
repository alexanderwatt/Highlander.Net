...
namespace Highlander.Tests.V5r3
{
    /// <summary>
    ...
    public class DateTimeZoneParserTests
    {
        ...
        public void TestRdpRequiredChar()
        {
            ...
            using (MemoryStream ms = new MemoryStream(Encoding.UTF8.GetBytes("")))
            {
                Assert.IsFalse(DateTimeZoneParser.ParseChar(ms, null, true, out var result));
                Assert.IsTrue(DateTimeZoneParser.ParseEndOfStream(ms));
            ...
            using (MemoryStream ms = new MemoryStream(Encoding.UTF8.GetBytes("+")))
            {
                Assert.IsTrue(DateTimeZoneParser.ParseChar(ms, '+', true, out var result));
                Assert.IsTrue(DateTimeZoneParser.ParseEndOfStream(ms));
            ...
            using (MemoryStream ms = new MemoryStream(Encoding.UTF8.GetBytes("*")))
            {
                Assert.IsTrue(DateTimeZoneParser.ParseChar(ms, null, true, out var result));
                Assert.IsTrue(DateTimeZoneParser.ParseEndOfStream(ms));
                Assert.IsTrue(result.HasValue);
                Assert.AreEqual<char>('*', result.Value);
            }
            ...
            using (MemoryStream ms = new MemoryStream(Encoding.UTF8.GetBytes("+")))
            {
                Assert.IsFalse(DateTimeZoneParser.ParseChar(ms, '-', true, out var result));
                Assert.IsFalse(result.HasValue);
                // retry
        ...
        public void TestRdpOptionalChar()
        {
            using (MemoryStream ms = new MemoryStream(Encoding.UTF8.GetBytes("")))
            {
                Assert.IsTrue(DateTimeZoneParser.ParseChar(ms, '+', false, out var result));
                Assert.IsTrue(DateTimeZoneParser.ParseEndOfStream(ms));
                Assert.IsFalse(result.HasValue);
            }
            using (MemoryStream ms = new MemoryStream(Encoding.UTF8.GetBytes("+")))
        ...
        public void TestRdpRequiredDecDigits()
        {
            ...
            {
                // required
                Assert.IsFalse(DateTimeZoneParser.ParseDecDigits(ms, true, out var result));
                // optional
            ...
            using (MemoryStream ms = new MemoryStream(Encoding.UTF8.GetBytes("999 111")))
            {
                ...
                Assert.IsTrue(DateTimeZoneParser.ParseDecDigits(ms, true, out var result));
                Assert.AreEqual<long>(3, ms.Position);
                Assert.IsTrue(result.HasValue);
                Assert.AreEqual<int>(999, result.Value);
                Assert.IsTrue(DateTimeZoneParser.ParseChar(ms, ' ', true, out _));
        ...
        public void TestRdpRequiredHexDigits()
        {
            ...
            {
                // required
                Assert.IsFalse(DateTimeZoneParser.ParseHexDigits(ms, null, true, out var result));
                // optional
            ...
            {
                Assert.AreEqual<long>(0, ms.Position);
                Assert.IsTrue(DateTimeZoneParser.ParseHexDigits(ms, null, true, out var result));
                Assert.AreEqual<long>(3, ms.Position);
                Assert.IsTrue(result.HasValue);
        ...
        public void TestRdpIntegers()
        {
            ...
            foreach (var testPair in testPairs)
            {
                ...
                {
                    Assert.IsTrue(DateTimeZoneParser.ParseInt32(ms, false, out var result), String.Format("Input='{0}'", testPair.Input));
