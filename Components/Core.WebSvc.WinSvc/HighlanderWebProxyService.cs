...
namespace Highlander.Core.WebService
{
    public partial class HighlanderWebProxyService: ServiceBase
    {
        public HighlanderWebProxyService()
        {
            InitializeComponent();
        }
        ...
        protected override void OnStart(string[] args)
        {
            ...
            try
            {
                ...
                _server = new HighlanderWebProxyServer { LoggerRef = loggerRef, Client = _clientRef};
                _server.Start();
            }
            catch (Exception ex)
            {
