...
namespace Highlander.Numerics.Maths.Collections
{
    ...
    public class Vector<T> : ICloneable, IEnumerable<T>
    {
        ...
        //----------------------------------------------------------------------------------------------
        public void Sort(Highlander.Numerics.Maths.Collections.IComparable<T> compare)
        {
          _list.Sort(compare);
        }
        ...
        //----------------------------------------------------------------------------------------------
        public Position Find(Highlander.Numerics.Maths.Collections.IComparable<T> func)
        {
          int top    = 0;
          int bottom = Count - 1;
