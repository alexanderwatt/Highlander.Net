...
namespace Highlander.Utilities.Threading
{
    public class AsyncResultNoResult : IAsyncResult
    {
        ...
        private const int CStatePending = 0;
        private const int CStateCompletedSynchronously = 1;
        private const int CStateCompletedAsynchronously = 2;
        private int _mCompletedState;
        ...
        public void SetAsCompleted(Exception exception, Boolean completedSynchronously)
        {
            ...
            int prevState = Interlocked.Exchange(ref _mCompletedState,
        ...
        public bool CompletedSynchronously => _mCompletedState == CStateCompletedSynchronously;
        ...
        public bool IsCompleted => _mCompletedState != CStatePending;
    ...
    public delegate void AsyncErrorDelegate<in TContext>(Exception excp, TContext context);
