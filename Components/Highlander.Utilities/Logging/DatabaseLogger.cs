...
namespace Highlander.Utilities.Logging
{
    ...
    public class DatabaseLogger : BaseLogger, IDatabaseLogger
    {
        ...
        internal IDictionary<MandatoryLogField, string> FieldMappings { get; }
            ...
            : base(prefix, null)
        {
            ...
            bool delayPersistence = persistInterval > 0;
            Logger = InitialiseLogger(delayPersistence);
        ...
        /// </summary>
        /// <param name="delayPersistence"></param>
        private DatabaseLog InitialiseLogger(bool delayPersistence)
        {
            var logging = new DataSet();
            logging.Tables.Add(LogTable);
            var logger = new DatabaseLog(delayPersistence)
                                     {
