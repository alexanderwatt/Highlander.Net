...
namespace Orion.V5r3.Identifiers.Tests
{
    ...
    public class PricingStructureIdTests
    {
        ...
        {
            var rateCurveId = new PricingStructureIdentifier(PricingStructureTypeEnum.RateCurve, _liborIndexName, _baseDate);
        ...
        public void PricingStructureIdTestWithProperties4()
        {
            NamedValueSet props = new NamedValueSet();
            props.Set(CurveProp.PricingStructureType, "RateCurve");
            props.Set("Identifier", "RateCurve." + _liborIndexName + "." + _baseDate);
            props.Set("BuildDateTime", _baseDate);
            props.Set(CurveProp.BaseDate, _baseDate);
            props.Set(CurveProp.CurveName, _liborIndexName);
            props.Set("Algorithm", "Default");
        ...
        {
            var rateCurveId = new PricingStructureIdentifier("RateCurve." + _liborIndexName + "." + _baseDate);
