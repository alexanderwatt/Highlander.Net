...
namespace CalendarEngine.Tests 
{
    ...
    public class CalendarEngineTests
    {
        ...
        private readonly string[] _exchanges = { "IR", "L", "ED", "ER", "W", "IB", "EY", "ZB", "ES", "RA", "HR", "BAX"};
        ...
        private static CalendarUnitTestEnvironment UTE { get; set; }
        ...
        {
            UTE = new CalendarUnitTestEnvironment();
        ...
        public void ShortFinalStubSpecifiedCalculationPeriodDates()
        {
            ...
            Swap trade = (Swap)swapTrade.trade[0].Item;
        ...
        public void TestBusinessCalendarHelperWithBusinessCenters()
        {
            ...
            x = CalendarEngine.IsHoliday(new[] { "AUSY" }, DateTime.Today);
            x = CalendarEngine.IsHoliday(new[] { "AUSY", "Sydney" }, DateTime.Today);
            x = CalendarEngine.IsHoliday(new[] { "Sydney", "AUSY" }, DateTime.Today);
        }
        ...
        [TestMethod]
        public void GetAdjustedDates3Backward()
        {
            DateTime startDate = new DateTime(2008, 04, 10);
            DateTime endDate = new DateTime(2009, 04, 24);
            RollConventionEnum rollConventionEnum = RollConventionEnumHelper.Parse(endDate.Day.ToString());
        ...
        [TestMethod]
        public void GetAdjustedDates2Forward()
        {
            DateTime startDate = new DateTime(2008, 04, 10);
            DateTime endDate = new DateTime(2009, 04, 24);
            Period interval = IntervalHelper.FromMonths(3);
        ...
        [TestMethod]
        public void GetAdjustedDates2Backward()
        {
            DateTime startDate = new DateTime(2008, 04, 10);
            DateTime endDate = new DateTime(2009, 04, 24);
            Period interval = IntervalHelper.FromMonths(3);
        ...
        public void DatesScheduleGeneratorGetDatesSchedule()
        {
            ...
            {
                ThreeStringsRangeItem threeStringsRangeItem =
                    new ThreeStringsRangeItem
                    {
