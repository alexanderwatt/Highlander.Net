    ...
    public class MarketDataRealtimeServer : IMarketDataClient
    {
        ...
        public void Start()
        {
            ...
            switch (_providerId)
            {
                ...
                //    _MarketDataProvider = MdpFactoryNabCurveDb.Create(_Logger, _Client, OnProviderDataCallback);
                //    break;
                default:
                    throw new ArgumentException("Unknown MarketDataProviderId: " + _providerId.ToString());
            }
