...
namespace FpML.V5r10.CalendarEngine.Dates
{
    ///<summary>
    ///</summary>
    public class FirstFridayPlusSix : LastTradingDate
    {
        /// <summary>
        /// Base constructor, which does not filter for main cycle or not.
        /// </summary>
        public FirstFridayPlusSix()
        {
        ...
        public FirstFridayPlusSix(string exchangeCommodityCode, string expiryMonthAndYear)
        ...
        public FirstFridayPlusSix(string exchangeCommodityName)
