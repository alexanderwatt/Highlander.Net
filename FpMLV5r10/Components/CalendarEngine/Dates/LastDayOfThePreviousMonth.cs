...
namespace FpML.V5r10.CalendarEngine.Dates
{
    ///<summary>
    ///</summary>
    public class LastDayOfThePreviousMonth : LastTradingDate
    {
        /// <summary>
        /// Base constructor, which does not filter for main cycle or not.
        /// </summary>
        public LastDayOfThePreviousMonth()
        {
        }
        ...
        /// </summary>
        /// <param name="expiryMonthAndYear">Name of the exchange commodity.</param>
        ///  <param name="expiryMonthAndYear">Name of the expiryMonthAndYeary.</param>
        public LastDayOfThePreviousMonth(string exchangeCommodityCode, string expiryMonthAndYear)
        ...
        public LastDayOfThePreviousMonth(string exchangeCommodityName)
