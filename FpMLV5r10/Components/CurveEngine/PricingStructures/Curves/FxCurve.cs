...
namespace Orion.CurveEngine.PricingStructures.Curves
{
    ...
    public class FxCurve : CurveBase, IFxCurve
    {
        ...
        {
            var fxCurve = (FpML.V5r10.Reporting.FxCurve)PricingStructure;
        ...
        {
            FpML.V5r10.Reporting.FxCurve fxCurve = CreateFxCurve(curveId.Id, curveId.CurveName, curveId.QuotedCurrencyPair, curveId.Currency);
        ...
        /// <returns></returns>
        private static FpML.V5r10.Reporting.FxCurve CreateFxCurve(string id, string name, QuotedCurrencyPair quotedCurrencyPair,
                                                          Currency currency)
        {
        ...
        /// <returns></returns>
        protected static FpML.V5r10.Reporting.FxCurve CreateFxCurve(FxCurveIdentifier curveId)
        {
            var fxCurve = new FpML.V5r10.Reporting.FxCurve
            {
                id = curveId.Id,
        ...
        {
            FpML.V5r10.Reporting.FxCurve fxCurve = CreateFxCurve(curveId);
        ...
        private static Pair<PricingStructure, PricingStructureValuation> CloneCurve(Pair<PricingStructure, PricingStructureValuation> fxCurve, string curveId)
        {
            ...
            //
            var fx = (FpML.V5r10.Reporting.FxCurve)fxCurveCloned;
            fx.id = curveId;
