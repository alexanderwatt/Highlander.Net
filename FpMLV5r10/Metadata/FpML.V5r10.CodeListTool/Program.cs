...
namespace FpML.V5r10.CodeListTool
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            outerIterator.Iterations[0].Tokens.Set("NameSpace", "FpML.V5r10.Codes");
            ...
            string[] xmlFiles = Directory.GetFiles(@"..\..\..\..\FpML.V5r10\fpml.org\download\codelist", "*.xml", SearchOption.AllDirectories);
