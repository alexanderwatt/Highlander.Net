...
namespace nab.QDS.FpML.V47
{
    public partial class QuotedAssetSet
    {
            ...
            bool includeEmptyAdditionalQuotes)
        {
            ...
            {
                foreach (Asset asset in instrumentSet)
                {
            ...
            if (additional.instrumentSet != null)
            {
                foreach (Asset asset in additional.instrumentSet)
                {
                    string assetId = asset.id;
            ...
            // done
            result.instrumentSet = instrumentMap.Values.ToArray();
