...
namespace FpML.V5r10.Reporting.ModelFramework.Calibrators.Bootstrappers
{
    ...
    public interface IBootstrapPriceableFxAssetController<D, R> : IBootstrapController<D, R>
    {
        /// <summary>
        ...
        /// <returns></returns>
        R Calculate(D bootstrapData, IPriceableFxAssetController[] priceableAssets);
    }
}