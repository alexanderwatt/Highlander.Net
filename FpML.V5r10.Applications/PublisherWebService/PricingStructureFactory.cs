...
namespace Orion.V5r10.PublisherWebService
{
    internal static class PricingStructureFactory
    {
        ...
        internal static IPricingStructure CreatePricingStructure(ILogger logger, ICoreCache cache, string nameSpace, object[][] propertiesRange, object[][] values)
        {
            ...
            {
                return CurveEngine.Factory.PricingStructureFactory.CreatePricingStructure(logger, cache, nameSpace, null, null, properties, ConvertObjectArray(values));
            }
            ...
            if (PricingStructureHelper.VolSurfaceTypes.Contains(psType))
            {
                ...
                return CurveEngine.Factory.PricingStructureFactory.CreateVolatilitySurface(logger, cache, nameSpace, properties, expiries, strikes, volatilities);
            }
