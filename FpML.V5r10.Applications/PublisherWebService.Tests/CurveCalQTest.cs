...
using Orion.V5r10.PublisherWebService;
...
namespace PublisherWebService.Tests
{
    ...
    public class CurveCalQ
    {
        ...
        private const string RateCurveIndexName = "AUD-BBR-BBSW";
        ...
        public void PublishLpmCurve3MTest()
        {
            ...
            Assert.AreEqual("Market.LiveUnitTest.RateCurve.AUD-AUDSwap-3M", result);
            DeleteMarket(result);
        }
        ...
        public void PublishLpmCurve6MTest()
        {
            ...
            Assert.AreEqual("Market.LiveUnitTest.RateCurve.AUD-AUDSwap-6M", result);
            DeleteMarket(result);
