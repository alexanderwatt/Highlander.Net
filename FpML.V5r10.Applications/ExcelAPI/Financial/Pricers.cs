    ...
    {      
            ...
            DateTime valuationDate, string discountCurveId)
        {
            ...
            if (tradeItem.Data is Trade trade)
            {
                ...
                var valuationId = new Orion.ValuationEngine.Valuations.Valuation().CreateTradeValuationReport(Engine.Cache, NameSpace, valuationIdentifier.UniqueIdentifier, party1, party2, isParty1Base, trade, market.GetFpMLData(), assetValuationReport, valProperties);
                return valuationId;
            }
            return null;
        }
        ...
        //public double qGetInterestRateSwapFairSpread(string uniqueTradeId, string reportingParty, string reportingCurrency,
        //    DateTime valuationDate)
        //{
        ...
        //public double qGetInterestRateSwapParRate(string uniqueTradeId, string reportingParty, string reportingCurrency,
