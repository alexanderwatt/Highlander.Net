...
namespace Highlander.CurveEngine.V5r3.PricingStructures
{
    ...
    /// </summary>
    public class SimpleCommodityCurve : SimpleBaseCurve, ICommodityCurve
    {
        /// <summary>
        /// SimpleCommodityCurve
        /// </summary>
        ...
        public SimpleCommodityCurve(DateTime baseDate, InterpolationMethod interpolation, bool extrapolation,
