...
namespace Highlander.CurveEngine.V5r3.PricingStructures.Curves
{
    ...
    public class CommodityCurve : CurveBase, ICommodityCurve
    {
        ...
        private const string DefaultAlgorithmName = "LinearForward";
            ...
            NamedValueSet properties, FxRateSet assetSet, IBusinessCalendar fixingCalendar, IBusinessCalendar rollCalendar, double tolerance)
        {
            ...
            //  Get algorithm name from the properties
            //
...
// ReSharper restore EmptyGeneralCatchClause
        ...
        public static Pair<PricingStructure, PricingStructureValuation> CloneCurve(Pair<PricingStructure, PricingStructureValuation> commodityCurve, string curveId)
        {
            ...
            //
            var yc = (Reporting.V5r3.FxCurve)ycCurveCloned;
            yc.id = curveId;
        ...
        /// <returns></returns>
        private static Reporting.V5r3.FxCurve CreateCommodityCurve(string curveId, string name, Currency currency)
        {
            //            var currencyPair = QuotedCurrencyPairHelper.Parse(currency.Value, currency.Value, QuoteBasisEnum.Currency2PerCurrency1);

            var commodityCurve = new Reporting.V5r3.FxCurve
            {
                id = curveId,
                name = name,
                currency = currency
            ...
            IBusinessCalendar fixingCalendar, IBusinessCalendar rollCalendar)
        {
            ...
            var quotedCurrencyPair = ((Reporting.V5r3.FxCurve)GetFpMLData().First).quotedCurrencyPair;
        ...
        {
            Reporting.V5r3.FxCurve yieldCurve = CreateCommodityCurve(curveId);
            FxCurveValuation yieldCurveValuation = CreateCommodityCurveValuation(curveId, quotedAssetSet, yieldCurve.id, termCurve);
        ...
        /// <param name="curveId">The curve id.</param>
        /// <returns></returns>
        protected static Reporting.V5r3.FxCurve CreateCommodityCurve(CommodityCurveIdentifier curveId)
        {
            var yieldCurve = new Reporting.V5r3.FxCurve
            {
                id = curveId.Id,
        ...
        /// <param name="commodityCurveId">The commodity curve id.</param>
        /// <param name="forwardCurve">The curve</param>
        /// <returns></returns>
        protected static FxCurveValuation CreateCommodityCurveValuation(PricingStructureIdentifier curveId, FxRateSet quotedAssetSet,
                                                                       string commodityCurveId, TermCurve forwardCurve)
        {
