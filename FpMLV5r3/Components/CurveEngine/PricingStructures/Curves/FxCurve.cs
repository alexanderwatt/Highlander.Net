...
namespace Highlander.CurveEngine.V5r3.PricingStructures.Curves
{
    ...
    public class FxCurve : CurveBase, IFxCurve
    {
        ...
        {
            var fxCurve = (Reporting.V5r3.FxCurve)PricingStructure;
        ...
        {
            var fxCurve = CreateFxCurve(curveId.Id, curveId.CurveName, curveId.QuotedCurrencyPair, curveId.Currency);
        ...
        /// <param name="quotedCurrencyPair">The quoted currency pair.</param>
        /// <param name="currency"></param>
        /// <returns></returns>
        private static Reporting.V5r3.FxCurve CreateFxCurve(string id, string name, QuotedCurrencyPair quotedCurrencyPair,
                                                          Currency currency)
        {
        ...
        /// <returns></returns>
        protected static Reporting.V5r3.FxCurve CreateFxCurve(FxCurveIdentifier curveId)
        {
            var fxCurve = new Reporting.V5r3.FxCurve
            {
                id = curveId.Id,
        ...
        private decimal Recipricate(decimal value)
        {
            ...
            return Reciprocal ? 1/value : value;
        }
        ...
        {
            Reporting.V5r3.FxCurve fxCurve = CreateFxCurve(curveId);
        ...
        private static Pair<PricingStructure, PricingStructureValuation> CloneCurve(Pair<PricingStructure, PricingStructureValuation> fxCurve, string curveId)
        {
            ...
            //
            var fx = (Reporting.V5r3.FxCurve)fxCurveCloned;
            fx.id = curveId;
