...
using Highlander.CalendarEngine.V5r3.Rules;
...
namespace Highlander.CurveEngine.V5r3
{
    /// <summary>
    ...
    public class CurveEngine : ICurveEngine
    {
        ...
        /// <param name="properties">The properties.</param>
        /// <returns>The id.</returns>
        public string[,] CreateLocalSurfaceAssets(List<string> assetIdentifier, DateTime baseDate, decimal[,] volatility, List<decimal> strikes,
                                                    NamedValueSet properties)
        {
        ...
        /// <param name="instruments">The curve instruments.</param>
        ...
        /// <returns></returns>
        public IPricingStructure CreatePricingStructure(NamedValueSet properties, DateTime baseDate, List<string> instruments, List<decimal> values, List<decimal> additional, Algorithm algorithm)
        {
            var structure = PricingStructureFactory.CreatePricingStructure(Logger, Cache, NameSpace, null, null, properties, instruments, values, additional, algorithm);
            return structure;
        }
        ...
        public string CreateLeaseConfiguration(string id, string currency, string paymentFrequency, string businessDayConvention, string businessCentersAsString)
        {
            ...
            itemProps.Set(EnvironmentProp.DataGroup, "Highlander.V5r3.Reporting.Configuration.Instrument");
            ...
            string underlyingCurve, string compoundingFrequency, string extrapolation, string dayCounter)
        {
            ...
            var uniqueName = NameSpace + "." + name;
            var itemProps = new NamedValueSet();
            itemProps.Set(EnvironmentProp.DataGroup, "Highlander.V5r3.Reporting.Configuration.Algorithm");
            itemProps.Set(EnvironmentProp.SourceSystem, "Highlander");
            itemProps.Set(EnvironmentProp.Function, FunctionProp.Configuration.ToString());
