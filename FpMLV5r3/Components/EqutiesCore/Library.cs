  ...
  public class EquitiesLibrary
  {
      ...
      /// <returns></returns>
            ...
            DateTime[] zeroDates, double[] zeroRates, DateTime[] divDates, double[] divAms)
        {
            ...
            double pr = myPrice.BlackScholesPrice(fwd, t, strike, r, vol, paystyle);
            return pr;
        }
      ...
      /// <returns></returns>
        ...
        /// <returns></returns>
        public static double InterpolateOnDates(DateTime valueDate, DateTime[] dates, double[] amounts, string interpolationType)
        {
        ...
        /// <param name="interpolationType"></param>
        /// <returns></returns>
        public static double InterpolateOnValues(double xValue, double[] x, double[] y, string interpolationType)
        {
            //At this stage only linear interpolation is supported
