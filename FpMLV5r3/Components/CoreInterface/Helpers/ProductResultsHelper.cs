...
namespace Highlander.Core.Interface.V5r3.Helpers
{
    ///<summary>
    ///</summary>
    public static class ProductResultsHelper
    {
        ...
        /// <returns></returns>
        public static object BuildResults(string[] metrics, string[] productReferenceKeys, TradeValuationItem[] valuations, bool displayHeadersInd)
        {
            int index = 0;
