...
using Valuation = Highlander.ValuationEngine.V5r3.Valuations.Valuation;
...
{
    public class InterestRateSwapPricer : SwapPricer, IObjectiveFunction
    {
        #region Properties
            ...
            List<AdditionalPaymentRangeItem> leg2AdditionalPaymentList)
        {
            ...
            {
                leg1DiscountCurve = (IRateCurve)CurveEngine.V5r3.CurveEngine.GetCurve(logger, cache, nameSpace, leg1ParametersRange.DiscountCurve, false);
            }
            if (leg2DiscountCurve == null)
            {
                leg2DiscountCurve = (IRateCurve)CurveEngine.V5r3.CurveEngine.GetCurve(logger, cache, nameSpace, leg2ParametersRange.DiscountCurve, false);
            }
