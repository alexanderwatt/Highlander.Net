...
using Highlander.Reporting.ModelFramework.V5r3.Instruments.ForeignExchange;
    ...
    public class FxSingleLegPricer : InstrumentControllerBase, IPriceableFxLeg<IFxLegParameters, IFxLegInstrumentResults>, IPriceableInstrumentController<FxSingleLeg>
    {
        ...
        public override DateTime[] GetBucketingDates(DateTime baseDate, Period bucketInterval)
        {
            ...
            if (Payments.Count > 1)
            {
                ...
                bucketDates = new List<DateTime>(DateScheduler.GetUnadjustedDatesFromEffectiveDate(baseDate, RiskMaturityDate, bucketInterval, RollConventionEnum.NONE, out firstRegularPeriodStartDate, out lastRegularPeriodEndDate));
            }
