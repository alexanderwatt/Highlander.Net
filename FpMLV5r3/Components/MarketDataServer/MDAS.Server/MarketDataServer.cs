...
using Highlander.MDS.Provider.Bloomberg.V5r3;
using Highlander.MDS.Provider.GlobalIB.V5r3;
using Highlander.MDS.Provider.Nab.V5r3;
using Highlander.MDS.Provider.Simulator.V5r3;
...
namespace Highlander.MDS.Server.V5r3
{
