...
using Highlander.ValuationEngine.Tests.V5r3.Helpers;
using Highlander.ValuationEngine.V5r3.Pricers;
using Highlander.ValuationEngine.V5r3.Generators;
using Highlander.ValuationEngine.V5r3.Valuations;
...
namespace Highlander.ValuationEngine.Tests.V5r3 
{
    [TestClass]
    public class ValuationEngineTests1
    {
        ...
        public static void Setup(TestContext context)
        {
            ...
            CurveEngine = new CurveEngine.V5r3.CurveEngine(UTE.Logger, UTE.Cache, UTE.NameSpace);
        ...
        private ValuationReport CreateValuationReport(string valuationReportId)
        {
            ...
            var marketFactory = new CurveEngine.V5r3.Factory.MarketFactory();
        ...
        public void AppendValuationIdToFilenameFullPath()
        {
            ...
            string s = ValuationEngine.V5r3.Valuations.Valuation.AppendValuationIdToFilename(filename, guid);
            Debug.Print(s);
