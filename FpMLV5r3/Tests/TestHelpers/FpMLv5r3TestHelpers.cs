...
namespace Highlander.TestHelpers.V5r3
{
    ...
    public static class TestHelper
    {
            ...
            bool validateOriginal, bool emitAndCompare, bool validateEmitted)
        {
            ...
            string sampleFilesPath = @"..\..\..\..\..\FpMLV5r3\Metadata\fpml.org\samples\5.3\" + viewName;
            // temp files
            ...
            bool validateOriginal, bool emitAndCompare, bool validateEmitted)
        {
            ...
            const string sampleFilesPath = @"..\..\..\..\..\FpMLV5r3\Metadata\fpml.org\samples\5.3\Confirmation\products";
            // temp files
            string incomingFullPath = Path.GetFullPath(@"..\..\step1incoming.xml");
            string fullPath = Path.GetFullPath(sampleFilesPath);
