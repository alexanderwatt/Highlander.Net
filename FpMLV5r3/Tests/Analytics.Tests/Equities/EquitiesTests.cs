...
namespace Highlander.Analytics.Tests.V5r3.Equities
{
    /// <summary>
    ...
    public class EquitiesTests
    {
        ...
        public EquitiesTests()
        { }

        public EquitiesTests(string pay)
        {
            this.pay = pay;
        }
        ...
        private void SetUpExampleOption1()
        {
            ...
            _style = "American";
            _smoothing = "N";  
            _rtdays = new int[] { 73, 365 };
            _rtamts = new double[] { 0.05, 0.05 };
            _divdays = new int[] { 0, 182, 365, 438 };
            _dd = new double[] { 5, 5, 5, 5 };
        }
        ...
        {         
            ...
            _strike = 1;
            _rtdays = new[] { 1, 2925 };
            _rtamts = new[] { 0.065, 0.065 };
            // resetAmts[4] = 6000;
            // resetAmts[5] = 4000;
            // resetAmts[9] = 3500;
            // resetAmts[11] = 4000;
            // resetAmts[12] = 6000;
            _divdays = new int[] { 31, 61, 92, 123, 151, 182, 212, 243, 273, 304, 335, 365, 396,
                                          1643, 1673, 1704, 1734, 1765, 1796, 1826, 1857, 1887, 1918,
                                          1949, 1977, 2008};
            _dd = new double[] { 12.438273064236,
                                12.0712191050975,
                                12.5112416423502,
                                12.5484879253083,
                                11.3631887529053,
        ...
        {
            SetUpExampleOption1();
            BinomialTreePricer lhs = new BinomialTreePricer(_spot,_strike,false,_tau,_vol,_steps,true,_style,_smoothing,_rtdays,_rtamts,_divdays,_dd,typeof(EquityPropDivTree));
        ...
        {
            SetUpExampleOption1();
            BinomialTreePricer lhs = new BinomialTreePricer(_spot, _strike, true, _tau, _vol, _steps, true, _style, _smoothing, _rtdays, _rtamts, _divdays, _dd, typeof(EquityPropDivTree));
            double price = lhs.GetPrice();
            double delta = lhs.GetDelta();
            double gamma = lhs.GetGamma();
            double vega = lhs.GetVega();
        ...
        public void TestAsianHybridCliquet5Y()
        {
            ...
            int[] resetDays = { 0, 31, 61, 92, 123, 151, 182, 212, 243, 273, 304, 335, 365,
                                          1643, 1673, 1704, 1734, 1765, 1796, 1826, 1857, 1887, 1918,
                                          1949, 1977, 2008};
            ...
            CliquetPricer ah = new CliquetPricer("AsianHybrid", _spot, _strike, _tau, _divdays, _dd, _rtdays, _rtamts, resetDays, resetAmts, vols, floor, cap, numsimulations, nobsin, nobsout,3151,true);
        ...
        public void TestTaurusCliquet1Y()
        {
            ...
            double strike = 1;
            int[] ratedays = { 1, 2925 };
            double[] rateamts = { 0.034932296, 0.0349322696 };
            int[] resetDays = { -347,-317,-286,-256,-225,-194,-166,-135,-105,-74,-44,-13,18,48,79,109};
            double[] vols = { 0.60, 0.60, 0.60, 0.60, 0.60, 0.60, 0.60, 0.60, 0.60, 0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.6 };
            double[] resetAmts = { 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 0, 0, 0, 0 };
            int[] divdays = { 0 };
            double[] divamts = { 0.0 };
            int numsimulations = 100000;
            int nobsin = 8;
        ...
        public void TestARO()
        {
            ...
            bool isCall = true;
            int[] ratedays = { 1, 2925 };
            double[] rateamts = { 0.044997, 0.044997 };
            int[] divdays = { 103,
                                        278,
                                        467,
                                        642,
                                        831,
                                        1006};
            double[] divAmts = { 0.4400, 0.4800, 0.5200, 0.5400, 0.5800, 0.6000 };
            int[] resetDays = {983,
                                        1013,
                                        1043,
                                        1073,
                                        ...
                                        1163,
                                        1182};
            double[] resetAmts = { 0, 0, 0, 0, 0, 0, 0, 0 };
            double[] volatilities = { 0.3612, 0.3612, 0.3612, 0.3612, 0.3612, 0.3612, 0.3612, 0.3612 };
        ...
        public void AROPartialReadings()
        {
            ...
            double[] divAmts = { 0.4400, 0.4800, 0.5200, 0.5400, 0.5800, 0.5983 };
            ...
            double[] resetAmts = { 42.69, 42.1, 0, 0, 0, 0, 0, 0 };
