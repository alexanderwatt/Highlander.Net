...
namespace Orion.V5r3.Configuration
{
    ...
    public partial class AlertSignal : IComparable<AlertSignal>
    {
        ...
        {
            // ascending RuleName
            int result = System.String.Compare(this.RuleName, signal.RuleName, System.StringComparison.OrdinalIgnoreCase);
            if (result != 0)
                return result;

            // ascending AlertServer
            result = System.String.Compare(this.AlertServer, signal.AlertServer, System.StringComparison.OrdinalIgnoreCase); // A -> Z
            return result;
        }
