...
namespace Orion.ModelFramework.Calibrators.Bootstrappers
{
    ...
    public interface IBootstrapPriceableDividendAssetController<D, R> : IBootstrapController<D, R>
    {
        /// <summary>
        ...
        /// <returns></returns>
        R Calculate(D bootstrapData, IPriceableDividendAssetController[] priceableAssets);
    }
}