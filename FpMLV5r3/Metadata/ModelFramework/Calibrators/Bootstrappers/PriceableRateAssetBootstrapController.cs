...
namespace Orion.ModelFramework.Calibrators.Bootstrappers
{
    ...
    /// 
    /// </summary>
    abstract public class PriceableRateAssetBootstrapController : IBootstrapPriceableRateAssetController<IBootstrapControllerData, IPricingStructure>
    {
        /// <summary>
        /// Gets the id.
        /// </summary>
        ...
        /// <returns></returns>
        abstract public IPricingStructure Calculate(IBootstrapControllerData bootstrapData, IPriceableRateAssetController[] priceableAssets);
        ...
        public PriceableRateAssetBootstrapController()
        {
            Id = string.Empty;
        }
    }
