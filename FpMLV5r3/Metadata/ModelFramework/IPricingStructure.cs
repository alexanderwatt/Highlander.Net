...
namespace Highlander.Reporting.ModelFramework.V5r3
{
    ...
    public class PricingStructureData
    {
        ...
        public PricingStructureData(CurveType curveType, AssetClass assetClass)
        {
            CurveType = curveType;
        ...
        public PricingStructureData(CurveType curveType, AssetClass assetClass, NamedValueSet properties)
        {
            CurveType = curveType;
            AssetClass = assetClass;
            PricingStructureRiskSetType = PricingStructureRiskSetType.Parent;
