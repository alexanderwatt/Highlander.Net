...
namespace Highlander.Reporting.Analytics.V5r3.Options
{
    ...
    public class OptionAnalytics
    {
        ...
        //const double Oor2PI = 0.398942280401433; // 1/sqrt(2.pi)  -> InvSqrt2Pi 
        //const double Oo2PI = 0.159154943091895;  // 1/(2.pi} -> Inv2PI
  ...
  double strike, double vol, double df, double t)
        ...
        public static double[] ChooserOpt(double fwdPrice, double vol, double tS, double tL, double strike, double rL) 
        {
            ...
            v = Maths.Constants.InvSqrt2Pi * Math.Exp(-h2 * h2 / 2);
...
//}
          ...
          double t)           // time to option expiry in years
        {
          ...
          var c9k = -c1k;
          var t3 = Maths.Constants.InvSqrt2Pi * IntegrationHelpers.LogNormalIntegration(nSteps, FSpread3, strike, -1, q1, fwdPrice1, P)[0];
