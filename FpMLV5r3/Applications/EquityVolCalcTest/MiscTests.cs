...
namespace Highlander.EquitiesCalculator.Tests.V5r3
{
    ...
    public class MiscTests
    {
        ...
        public void CanGetVolatilityFromWingParameterSurface()
        {
            ...
            if (stock.VolatilitySurface.Expiry[0].Strikes[0].InterpolationModel.GetType() == typeof(WingModelInterpolation))
            {
                //FO Wing parameters
                ...
                List<double> strikes = new List<double> { (double)stock.VolatilitySurface.Expiry[0].FwdPrice };
        ...
        private static VolatilitySurface CreateSurface(Stock stock)
        {
            ...
            foreach (DateTime date in dates)
            {
                ...
                {
                    var str = new EquityStrike(Math.Round(Convert.ToDouble(expiry.FwdPrice) * moneyness,2) , null, null, Units.Cents);
