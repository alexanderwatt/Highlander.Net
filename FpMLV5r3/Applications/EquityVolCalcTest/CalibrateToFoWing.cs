...
namespace Highlander.EquitiesCalculator.Tests.V5r3
{
    ...
    public class CalibrateToFoWing
    {
        ...
        public void CanGetVolatilityFromWingParameterSurface()
        {
            ...
            var stock = new Stock(new DateTime(2009, 9, 9), 3769, "BHP", "BHP", rateCurve, divCurve);         
            //create SD grid vols
          ...
          //  stock.VolatilitySurface.AddExpiry(expiryFo2);
            ...
            double cc = result[0].Strikes[0].InterpolationModel.WingParameters.CallCurve;
        ...
        private static VolatilitySurface CreateSurface(Stock stock)
        {
           ...
           var expiry2 = new ForwardExpiry
           {
            ...
            {
                var str = new EquityStrike(strikes[idx], null, null, Units.Cents);
