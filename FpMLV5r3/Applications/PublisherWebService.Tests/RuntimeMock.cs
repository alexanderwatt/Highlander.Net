...
namespace Highlander.PublisherWebService.Tests.V5r3
{
    internal class RuntimeMock : ICoreClient
    {
        ...
        public List<ISubscription> Subscriptions => throw new NotImplementedException();

        public List<ICoreItem> Items => throw new NotImplementedException();

        public int ItemCount => throw new NotImplementedException();

        public int CreateCount => throw new NotImplementedException();

        public int UpdateCount => throw new NotImplementedException();

        public int DeleteCount => throw new NotImplementedException();

        public ICoreClient Proxy => throw new NotImplementedException();
        ...
        public ServiceAddress ServerAddress => throw new NotImplementedException();
        ...
        public ICoreItem LoadItem(string name) => throw new NotImplementedException();
        ...
        public ICryptoManager CryptoManager => throw new NotImplementedException();
        ...
        public CoreModeEnum CoreMode => throw new NotImplementedException();

        public CoreStateEnum CoreState => throw new NotImplementedException();
