...
namespace Highlander.EquityVolatilityCalculator.V5r3
{
    ...
    public class Wrapper
    {
        ...
        /// <param name="inZero">The in zero.</param>
        /// <returns></returns>
        public static DivList UnpackDividends(Equities.SimpleStock inStock, ZeroAUDCurve inZero)
        {
        ...
        /// <param name="inStock">The in stock.</param>
        /// <returns></returns>
        public static OrcWingVol UnpackOrcWingParameters(Equities.SimpleStock inStock)
        {
