...
{
    public partial class TradeEventManagerForm : Form
    {
        ...
        public class TradeObj : BaseUIObj
        {
                ...
                : base(item)
            {
                try
                {
                    ...
                    TradeState = item.AppProps.GetValue(TradeProp.TradeState, Highlander.Codes.V5r3.TradeState.Undefined.ToString());
