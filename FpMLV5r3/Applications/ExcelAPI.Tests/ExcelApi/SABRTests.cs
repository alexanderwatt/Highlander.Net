...
namespace Highlander.Excel.Tests.V5r3.ExcelApi
{
    ...
    public partial class ExcelAPITests
    {
        ...
        public void CreateAtmCapFloorBootstrapEngineTest()
        {
            ...
            string result = cfInterface.CreateCapFloorATMCurve(ExcelAPITests.Engine.Logger, ExcelAPITests.Engine.Cache, ExcelAPITests.Engine.NameSpace, properties, volTypes,
        ...
        public void CreateSabrCapFloorEngineTest()
        {
            ...
            string result = SABRCapFloorInterface.Instance().CreateCapFloorCurve(ExcelAPITests.Engine.Logger, ExcelAPITests.Engine.Cache, 
                ExcelAPITests.Engine.NameSpace, settings, types, vols, dates, discounts);
            Assert.AreEqual(engineHandle, result);
        }
    }
}
