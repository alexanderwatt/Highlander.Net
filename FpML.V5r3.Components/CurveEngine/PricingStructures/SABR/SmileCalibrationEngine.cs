...
namespace Orion.CurveEngine.PricingStructures.SABR
{
    ...
    /// </summary>
    public class SmileCalibrationEngine
    {
        ...
        /// <summary>
        /// Gets the underlying SABR engine.
        /// </summary>
        public SABRCalibrationEngine SABRCalibrationEngine => _sabrEngine;
