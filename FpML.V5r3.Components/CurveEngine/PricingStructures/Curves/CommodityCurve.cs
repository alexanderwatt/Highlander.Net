...
// ReSharper restore EmptyGeneralCatchClause
        ...
        public static Pair<PricingStructure, PricingStructureValuation> CloneCurve(Pair<PricingStructure, PricingStructureValuation> commodityCurve, string curveId)
        {
            ...
            //
            var yc = (FpML.V5r3.Reporting.FxCurve)ycCurveCloned;
            yc.id = curveId;
        ...
        /// <returns></returns>
        private static FpML.V5r3.Reporting.FxCurve CreateCommodityCurve(string curveId, string name, Currency currency)
        {
            //            var currencyPair = QuotedCurrencyPairHelper.Parse(currency.Value, currency.Value, QuoteBasisEnum.Currency2PerCurrency1);

            var commodityCurve = new FpML.V5r3.Reporting.FxCurve
            {
                id = curveId,
                name = name,
                currency = currency
            ...
            IBusinessCalendar fixingCalendar, IBusinessCalendar rollCalendar)
        {
            ...
            var quotedCurrencyPair = ((FpML.V5r3.Reporting.FxCurve)GetFpMLData().First).quotedCurrencyPair;
        ...
        {
            FpML.V5r3.Reporting.FxCurve yieldCurve = CreateCommodityCurve(curveId);
        ...
        /// <param name="curveId">The curve id.</param>
        /// <returns></returns>
        protected static FpML.V5r3.Reporting.FxCurve CreateCommodityCurve(CommodityCurveIdentifier curveId)
        {
            var yieldCurve = new FpML.V5r3.Reporting.FxCurve
            {
                id = curveId.Id,
