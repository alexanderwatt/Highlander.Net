...
namespace Orion.CurveEngine.PricingStructures.Curves
{
    ...
    public class EquityCurve : CurveBase, IEquityCurve
    {
        ...
        {
            FpML.V5r3.Reporting.FxCurve fxCurve = CreateEquityCurve(curveId.Id, curveId.CurveName, curveId.Currency);
        ...
        /// <returns></returns>
        private static FpML.V5r3.Reporting.FxCurve CreateEquityCurve(string id, string name, Currency currency)
        {
        ...
        /// <returns></returns>
        protected static FpML.V5r3.Reporting.FxCurve CreateEquityCurve(EquityCurveIdentifier curveId)
        {
            var fxCurve = new FpML.V5r3.Reporting.FxCurve
            {
                id = curveId.Id,
        ...
        {
            FpML.V5r3.Reporting.FxCurve fxCurve = CreateEquityCurve(curveId);
        ...
        private static Pair<PricingStructure, PricingStructureValuation> CloneCurve(Pair<PricingStructure, PricingStructureValuation> equityCurve, string curveId)
        {
            ...
            //
            var eq = (FpML.V5r3.Reporting.FxCurve)eqCurveCloned;
            eq.id = curveId;
