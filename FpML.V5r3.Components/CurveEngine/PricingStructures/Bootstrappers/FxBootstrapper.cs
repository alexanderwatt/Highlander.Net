...
namespace Orion.CurveEngine.PricingStructures.Bootstrappers
{
    ///<summary>
    ///</summary>
    public static class FxBootstrapper
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static TermPoint[] Bootstrap(List<IPriceableFxAssetController> priceableAssets, DateTime baseDate, Boolean extrapolationPermitted, InterpolationMethod interpolationMethod)
        {
