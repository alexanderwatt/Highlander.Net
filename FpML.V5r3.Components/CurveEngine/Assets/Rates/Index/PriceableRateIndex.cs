...
namespace Orion.CurveEngine.Assets
{
    ///<summary>
    ///</summary>
    public abstract class PriceableRateIndex : PriceableSimpleRateAsset
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        protected PriceableRateIndex(string id, Decimal amount, DateTime effectiveDate, DateTime riskMaturityDate)
