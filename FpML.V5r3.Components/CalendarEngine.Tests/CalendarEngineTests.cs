...
namespace CalendarEngine.Tests 
{
    [TestClass]
    public class CalendarEngineTests
    {
        ...
        private static Orion.CalendarEngine.CalendarEngine CalendarEngine { get; set; }
        ...
        public static void Setup(TestContext context)
        {
            ...
            CalendarEngine = new Orion.CalendarEngine.CalendarEngine(UTE.Logger, UTE.Cache, UTE.NameSpace);
        ...
        public void HolidaysBetweenTest2()
        {
            ...
            string message = string.Format("{0} contains {1} holidays between {2:yyyy-MM-dd} and {3:yyyy-MM-dd}", Center, holidays.Count, start, end);
        ...
        {
            int[] year = new[] { DateTime.Today.Year };
        ...
        public void ShortFinalStubSpecifiedCalculationPeriodDates()
        {
            ...
            DateTime effectiveDate = ((AdjustableDate)XsdClassesFieldResolver.CalculationPeriodDatesGetEffectiveDate(cpd)).unadjustedDate.Value;
            DateTime termDate = ((AdjustableDate)XsdClassesFieldResolver.CalculationPeriodDatesGetTerminationDate(cpd)).unadjustedDate.Value;
        ...
        {
            CalendarEngine.GetCalendar(new string[] { "Sydney", "AUSY" });
            CalendarEngine.GetCalendar(new string[] { "Sydney", "AUSY" });
            CalendarEngine.GetCalendar(new string[] { "Sydney", "Sydney" });
            CalendarEngine.GetCalendar(new string[] { "AUSY", "AUSY" });
            CalendarEngine.GetCalendar(new string[] { "AUSY", "Sydney" });
            CalendarEngine.GetCalendar(new string[] { "AUSY", "Sydney", "AUSY" });
        ...
        public void TestBusinessCalendarHelperWithBusinessCenters2()
        {
            ...
            CalendarEngine.IsValidBusinessCalendar(new string[] { "Sydney", "AUSY" });
            CalendarEngine.IsValidBusinessCalendar(new string[] { "Sydney", "APPLE", "AUSY" });
        ...
        [TestMethod]
        public void TestSuportedCalendars()
        {
            string[] cals = new string[] { "Copenhagen" };
        ...
        public void TestBuildHolidayListViaHelper()
        {
            string[] calendars = { };
            string[] fpmlNames = { };
            this.GetCalendarList(CalendarMap, ref calendars, ref fpmlNames);
        ...
        [TestMethod]
        public void GetUnadjustedDates2_Forward()
        {
        ...
        [TestMethod]
        public void GetUnadjustedDates3_Forward()
        {
            DateTime startDate = new DateTime(2008, 04, 10);
            DateTime endDate = new DateTime(2009, 04, 24);
        ...
        [TestMethod]
        public void GetAdjustedDates3_Forward()
        {
            DateTime startDate = new DateTime(2008, 04, 10);
            DateTime endDate = new DateTime(2009, 04, 24);
        ...
        [TestMethod]
        public void GetUnadjustedDates2_Backward()
        {
            DateTime startDate = new DateTime(2008, 04, 10);
            DateTime endDate = new DateTime(2009, 04, 24);
        ...
        [TestMethod]
        public void GetUnadjustedDates3_Backward()
        {
            DateTime startDate = new DateTime(2008, 04, 10);
            DateTime endDate = new DateTime(2009, 04, 24);
        ...
        public void TestExchangeIRCode()
        {
            ...
            //dt = LastTradingDayHelper.GetLastTradingDay(refDate, "IR", "U1");

            //dt = LastTradingDayHelper.GetLastTradingDay("IR", "U1");

            //refDate = new DateTime(2008, 3, 21);
            //dt = LastTradingDayHelper.GetLastTradingDay(refDate, "IR", "U1");

            //refDate = new DateTime(2014, 3, 21);
            //dt = LastTradingDayHelper.GetLastTradingDay(refDate, "IR", "U1");

            //refDate = new DateTime(1995, 3, 21);
            //dt = LastTradingDayHelper.GetLastTradingDay(refDate, "IR", "U1");
        }
        ...
        public void TestExchangeIBCode()
        {
            ...
            refDate = new DateTime(2008, 3, 21);
            dt = LastTradingDayHelper.GetLastTradingDay(refDate, "IB", "H0");

            refDate = new DateTime(2007, 3, 21);
            dt = LastTradingDayHelper.GetLastTradingDay(refDate, "IB", "U1");

            dt = LastTradingDayHelper.GetLastTradingDay("IB", "U1");
        ...
        public void TestExchangeEDCode()
        {
            ...
            //dt = LastTradingDayHelper.GetLastTradingDay("ED", "U1");
        ...
        public void TestExchangeERCode()
        {
            ...
            //dt = LastTradingDayHelper.GetLastTradingDay("ER", "U1");
        ...
        public void TestExchangeLCode()
        {
            ...
            //dt = LastTradingDayHelper.GetLastTradingDay("L", "U1");
        ...
        //[TestMethod]
        //public void TestMainCycleAllExchangesCurrentDate()//This doesn't work when the future expiry has already happened in this current month!
        //{
        //    foreach (string exchange in _exchanges)
        //    {
        //        var ex = EnumHelper.Parse<FutureAssetAnalyticModelIdentifier>(exchange);
        //        var td = LastTradingDayHelper.Parse(ex);
        //        DateTime dt = td.nextLastTradingDate(DateTime.Today, true);
        //        int expected = CalculateNextQuarter();
        //        Assert.AreEqual(expected, dt.Month);
        //    }
        //}
