...
{
    public class CommodityForwardPricer : InstrumentControllerBase, IPriceableInstrumentController<Fra>, IPriceableFra<IFraInstrumentParameters, IFraInstrumentResults>
    {
        #region Properties
        ...
        protected const string CModelIdentifier = "CommodityForward";
        ...
        // Requirements for pricing
        public AdjustableOrRelativeDate ValueDate { get; set; }
        ...
        /// 
        /// </summary>
        public BullionPhysicalLeg BullionPhysicalLeg { get; set; }
        ...
        public override DateTime[] GetBucketingDates(DateTime baseDate, Period bucketInterval)
        {
            ...
            var bucketDates = new List<DateTime>(DateScheduler.GetUnadjustedDatesFromTerminationDate(baseDate, endDate, bucketInterval, RollConventionEnum.NONE, out firstRegularPeriodStartDate, out lastRegularPeriodEndDate));
