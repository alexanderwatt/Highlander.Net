                ...
                payFloatingCashflow =>
                    {
                        ...
                        if(payFloatingCashflow.Rate != null)
                        { payFloatingCashflowCombined.ForwardRate = (decimal)payFloatingCashflow.Rate; }
                ...
                recFixedCashflow =>
                    {
                        ...
                        if (recFixedCashflow.Rate != null)
                        { recFixedCashflowCombined.ForwardRate = (decimal)recFixedCashflow.Rate; }
                        // ReSharper disable AccessToModifiedClosure
