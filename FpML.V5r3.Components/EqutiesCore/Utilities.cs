...
namespace Orion.EquitiesCore
{
    ...
    public static class Utilities
    {
        ...
        public static double Interpolate(DateTime valueDate, DateTime[] dates, double[] amounts, string interpType)
        {
            //Need to check that lenght of dates is equal to length of amounts
            ...
            {
                //The date is outside of range - flatline amount
                return amounts[0];                
            }
        ...
        /// <exception cref="UnsortedDatesException"></exception>
        /// <exception cref="DateToLargeException"></exception>
        public static double Interpolate(double xvalue,  double[] x, double[] y, string interpType)
        {
            //Need to check that lenght of dates is equal to length of amounts
