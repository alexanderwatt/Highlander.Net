...
namespace Orion.CalendarEngine.Dates
{
    ///<summary>
    ///</summary>
    public class SecondWednesdayPlusFive : LastTradingDate
    {
        /// <summary>
        /// Base constructor, which does not filter for main cycle or not.
        /// </summary>
        public SecondWednesdayPlusFive()
        {
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="SecondWednesdayPlusFive"/> class.
        /// </summary>
        ...
        public SecondWednesdayPlusFive(string exchangeCommodityCode, string expiryMonthAndYear)
        ...
        public SecondWednesdayPlusFive(string exchangeCommodityName)
        ...
        {
            var significantDate = RuleHelper.GetNthDayInMonth(month, 2, 3, year, 0, 5);
        ...
        public override DateTime NextLastTradingDate(DateTime refDate, bool mainCycle) 
        {
            ...
            if (result<=refDate)
                result = NextLastTradingDate(new DateTime(y, m, 21), mainCycle);
            return result;
        }

        /// <summary>
        /// 
        /// EDH7,EDZ9 (90 day futures)
        /// </summary>
        /// <returns></returns>
        ...
        public override DateTime GetLastTradingDay(DateTime referenceDate)
        {
            ...
            if (CodeAndExpiryMonth.Year < referenceDate.Year % 10)
            {
                ...
                unadjustedExpirationDate = RuleHelper.GetNthDayInMonth(month, 2, 3, realYear, 0, 5);
            }
            else
            {
        ...
        public override string GetNextAbsoluteMainCycleCode(DateTime referenceDate)
        {
            ...
            {
                DateTime unadjustedExpirationDate = RuleHelper.GetNthDayInMonth(referenceMonth, 2, 3, referenceYear, 0, 5);
