...
namespace Orion.CalendarEngine.Dates
{
    ///<summary>
    ///</summary>
    public class ThirdWednesdayPlusTwo : LastTradingDate
    {
        /// <summary>
        /// Base consructor, which does not filter for main cycle or not.
        /// </summary>
        public ThirdWednesdayPlusTwo()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ThirdWednesdayPlusTwo"/> class.
        /// </summary>
        ...
        public ThirdWednesdayPlusTwo(string exchangeCommodityCode, string expiryMonthAndYear)
        ...
        public ThirdWednesdayPlusTwo(string exchangeCommodityName)
        ...
        {
            var significantDate = RuleHelper.GetNthDayInMonth(month, 3, 3, year, 0, 2);
        ...
        public override DateTime GetLastTradingDay(DateTime referenceDate)
        {
            ...
            if (CodeAndExpiryMonth.Year < referenceDate.Year % 10)
            {
                ...
                unadjustedExpirationDate = RuleHelper.GetNthDayInMonth(month, 3, 3, realYear, 0, 2);
            }
            else
            {
        ...
        public override string GetNextAbsoluteMainCycleCode(DateTime referenceDate)
        {
            ...
            {
                DateTime unadjustedExpirationDate = RuleHelper.GetNthDayInMonth(referenceMonth, 3, 3, referenceYear, 0, 2);
