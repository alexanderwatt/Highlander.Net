...
namespace Highlander.Metadata.Common
{
    ...
    {
        /// <summary>
        /// Undefined - Use the default serialization method.
        /// </summary>
        Undefined,      // 0
        Xml,            // 1
        Soap,           // 2
    ...
    public class CommonItem
    {
        ...
        public string UniqueName => _uniqueName ?? (_uniqueName = Highlander.Metadata.Common.CoreHelper.MakeUniqueName(ItemKind, AppScope, Name));
