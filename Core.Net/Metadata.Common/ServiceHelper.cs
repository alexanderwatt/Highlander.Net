...
namespace Highlander.Metadata.Common
{
    ...
    public class ServiceAddress
    {
        ...
        public ServiceAddress(string protocol, string addr, int defaultPort)
        {
            Protocol = protocol;
    ...
    public partial class ServiceHelper
    {
        ...
        public static void ParseBuildLabel(string fileVersion, out int majorVersion, out int minorVersion, out DateTime buildDate)
        {
            ...
            parsed = int.TryParse(fileVersionParts[0], out majorVersion);
            minorVersion = 0;
            parsed = parsed && int.TryParse(fileVersionParts[1], out minorVersion);
            //int yy = 0;
            //parsed = parsed && Int32.TryParse(fileVersionParts[2].Substring(0, 2), out yy);
            int monthNum = 0;
            parsed = parsed && int.TryParse(fileVersionParts[2].Substring(0, 2), out monthNum);
            int dd = 0;
            parsed = parsed && int.TryParse(fileVersionParts[2].Substring(2, 2), out dd);
            //int nn = 0;
