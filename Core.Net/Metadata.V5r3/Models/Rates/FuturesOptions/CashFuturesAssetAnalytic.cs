...
{
    public class CashFuturesAssetAnalytic : ModelAnalyticBase<IFuturesAssetParameters, RateMetrics>, IRateAssetResults
    {
        ...
        {
            get { return EvaluateConvexityAdjustment(AnalyticParameters.Rate); }
        }
        ...
        {
            return AnalyticParameters.Position * 24.66m;
        }
        ...
        {
            return AnalyticParameters.Position * (AnalyticParameters.Rate - ImpliedQuote) * 0.2466m;
