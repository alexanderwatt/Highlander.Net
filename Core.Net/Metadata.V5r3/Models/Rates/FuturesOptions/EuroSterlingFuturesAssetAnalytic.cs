...
{
    public class EuroSterlingFuturesAssetAnalytic : ModelAnalyticBase<IFuturesAssetParameters, RateMetrics>, IRateAssetResults
    {
        ...
        {
            return AnalyticParameters.Position * (AnalyticParameters.Rate - ImpliedQuote) * 12.5m;
        ...
        {
            return AnalyticParameters.Position * 12.5m;
        }
