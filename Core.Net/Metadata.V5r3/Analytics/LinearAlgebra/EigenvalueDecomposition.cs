...
namespace Highlander.Reporting.Analytics.V5r3.LinearAlgebra
{
            ...
            for (int l = 0; l < _n; l++)
            {
                ...
                if (m > l)
                {
                    ...
                    do 
                    {
                        ...
                        double r = Highlander.Reporting.Analytics.V5r3.Maths.Fn.Hypot(p, 1.0);
                        if (p < 0)
                        {
                            r = - r;
                        }
                        ...
                        for (int i = m - 1; i >= l; i--)
                        {
                            ...
                            g = c * e[i];
                            h = c * p;
                            r = Highlander.Reporting.Analytics.V5r3.Maths.Fn.Hypot(p, e[i]);
                            e[i + 1] = s * r;
                            s = e[i] / r;
                            c = p / r;
                            p = c * d[i] - s * g;
