...
namespace Orion.ModelFramework.Calibrators.Bootstrappers
{
    ...
    /// 
    /// </summary>
    abstract public class PriceableDividendAssetBootstrapController : IBootstrapPriceableDividendAssetController<IBootstrapControllerData, IPricingStructure>
    {
        /// <summary>
        /// Gets the id.
        /// </summary>
        ...
        /// <returns></returns>
        abstract public IPricingStructure Calculate(IBootstrapControllerData bootstrapData, IPriceableDividendAssetController[] priceableAssets);
