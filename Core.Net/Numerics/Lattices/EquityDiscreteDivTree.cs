...
namespace Highlander.Numerics.Lattices
{
    ...
    public class EquityDiscreteDivTree : EquityBinomialTree
    {
        ...
        public EquityDiscreteDivTree(double spot, double t, double vol, int steps, bool flag, int[] rateDays, double[] rateAmounts, int[] dividendDays, double[] dividendAmounts)
            : base(steps)
        {
            _tau = t;
            _sig = vol;
            ...
            _flatFlag = flag;
            _ratedays = rateDays;
            _rateamts = rateAmounts;
            _divdays = dividendDays;
            _divamts = dividendAmounts;
            MakeGrid(rateDays, rateAmounts, dividendDays, dividendAmounts);
        }
        ...
        /// <summary>
        /// Vector of up factors at each node point
        /// </summary>
        private double[] _up;

        /// <summary>
        /// Vector of dn factors at each node point
        /// </summary>
        private double[] _dn;

        /// <summary>
        /// Vector of forward rates at each node point
        /// </summary>
        private double[] _r;
