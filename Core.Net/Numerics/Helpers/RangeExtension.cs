...
namespace Highlander.Numerics.Helpers
{
    /// <summary>
    ...
    public static class RangeExtension
    {
        ...
        public static Array TrimNulls(this Array array)
        {
            ...
            var result = Array.CreateInstance(elementType ?? throw new InvalidOperationException(), new[] { nonNullRows, array.GetLength(1) },
