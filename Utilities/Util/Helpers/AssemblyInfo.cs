...
namespace Highlander.Utilities.Helpers
{
    ...
    internal class AssemblyInfo
    {
        ...
        public string CodeBaseName => Path.GetFileName(Assembly.CodeBase);
        ...
        /// </value>
        public bool HasStrongName => _assemblyName.GetPublicKey().Length > 0;
        ...
        /// <summary>
        /// Gets the <see cref="string"/> with the specified dictionary field.
        /// </summary>
        /// <value></value>
        ...
        {
            var assemblyBasePath = Path.GetDirectoryName(assembly.CodeBase);
            if (assemblyBasePath != null)
            {
