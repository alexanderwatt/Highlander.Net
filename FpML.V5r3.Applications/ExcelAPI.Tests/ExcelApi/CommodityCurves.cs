...
namespace Orion.ExcelAPI.Tests.ExcelApi
{
    ...
    public partial class ExcelAPITests
    {
        ...
        {
            IPricingStructure pricingStructure = ExcelApi.ExcelAPITests.Engine.CreatePricingStructure(structurePropertiesRange.ToNamedValueSet(), valuesRange);
            string structureId = pricingStructure.GetPricingStructureId().UniqueIdentifier;
            ExcelApi.ExcelAPITests.Engine.SaveCurve(pricingStructure);
            return structureId;
        }
