...
namespace Orion.Configuration
{
    public static class StressDefinitionLoader
    {
        ...
        public static void LoadScenarioDefinitions(ILogger logger, ICoreCache targetClient)
        {
            ...
            foreach (ScenarioRule scenarioRule in scenarioRules)
            {
                ...
                Pair<string, NamedValueSet> itemInfo = LoadConfigDataHelper.StandardConfigProps(scenarioProps, itemType, idSuffix);
        ...
        public static void LoadStressDefinitions(ILogger logger, ICoreCache targetClient)
        {
            ...
            foreach (StressRule stressRule in stressRules)
            {
                ...
                logger.LogDebug("  Loading {0} ...", idSuffix);
                Pair<string, NamedValueSet> itemInfo = LoadConfigDataHelper.StandardConfigProps(null, itemType, idSuffix);
