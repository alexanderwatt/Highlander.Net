    ...
    public static class ServiceHostRulesLoader
    {
            ...
            int? totalInstanceCount = null, int? localInstanceCount = null, int? localInstanceStart = null)
        {
            ...
            return new HostConfigRule
                ...
                serverImplType = "National.QRSC.Server." + fileName + "." + className,
                serverAssmName = "National.QRSC.Server." + fileName,
        ...
        private static HostConfigRule MakeRulePortfolioValuerServer(string buildCfg)
        {
            var assemblyPaths = new List<string>
                {
                    String.Format(
                        @"..\..\..\..\..\Silverlight\National.QRSC.PortfolioValuer\National.QRSC.PortfolioValuer.Services\bin\{0}",
                        buildCfg)
                };
            return new HostConfigRule
                {
                ...
                serverImplType = "National.QRSC.PortfolioValuer.Services.PortfolioValuerServer",
                serverAssmName = "National.QRSC.PortfolioValuer.Services",
                serverAssmPath = assemblyPaths.ToArray(),
                serverEnabled = true
            };
        ...
        private static void AddRuleSetUnitTest(string buildCfg, List<HostConfigRule> rules)
        {
            ...
            rules.Add(new HostConfigRule
                ...
                serverImplType = "National.QRSC.Server.DataExporter.DataExportServer",
                serverAssmName = "National.QRSC.Server.DataExporter",
            ...
            rules.Add(new HostConfigRule
                ...
                serverImplType = "National.QRSC.Server.TradeRevaluer.TradeValuationServer",
                serverAssmName = "National.QRSC.Server.TradeRevaluer",
