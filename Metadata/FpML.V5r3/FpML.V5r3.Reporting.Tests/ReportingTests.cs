...
//using nab.QR.FpML.V5r3.TestHelpers;

namespace FpML.V5r3.Reporting.Tests
{
    /// <summary>
    ...
    public class ReportingTests
    {
        ...
        public void TestReportingFpMLSamplesLoadAllValid()
        {
            ...
            Assert.AreEqual(TimeSpan.FromHours(10), localTimeOffset);//TimeSpan.FromHours(11)
        ...
        public void TestReportingRoundtripDateTimes()
        {
            ...
            DateTime expectedAsOfTime = new DateTime(1, 1, 1, 1, 8, 10);//11 became 12 then DateTime(1, 1, 1, 12, 8, 10)
            {
                ...
                Assert.AreEqual<DateTime>(asOfDate, orig.asOfDate.Value);
