...
namespace FpML.V5r3.Confirmation
{
    public static class AssetValuationHelper
    {
        ...
        /// <returns></returns>
        static public IDictionary<string, decimal[]> BucketValuationResults(string metric, IDictionary<string, decimal[]> valuationResults)
        {
            ...
            for (int index = 0; index < maxArrayCount; index++)
            {
                ...
                bucketedResults.Add(string.Format("{0}{1}", metric, indexStr), (from key in valuationResults.Keys
        ...
        /// </returns>
        static public Boolean IsVector(IDictionary<string, decimal[]> results)
        {
        ...
        /// <returns></returns>
        static public decimal[] AggregateJaggedArray(IEnumerable<decimal[]> jaggedArray)
        {
