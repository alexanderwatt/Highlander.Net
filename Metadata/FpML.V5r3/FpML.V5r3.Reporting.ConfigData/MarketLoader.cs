...
namespace Orion.V5r3.Configuration
{
    ...
    {
        private const string ResourcePath = "Orion.V5r3.Configuration";
        ...
        {
            Assembly assembly = Assembly.GetExecutingAssembly();
            const string prefix = "Orion.V5r3.Configuration.Config.Trade";
        ...
        {
            Assembly assembly = Assembly.GetExecutingAssembly();
            const string prefix = "Orion.V5r3.Configuration.Config.FixedIncome";
        ...
        {
            Assembly assembly = Assembly.GetExecutingAssembly();
            const string prefix = "Orion.V5r3.Configuration.Config.QuotedAssetSet";
            logger.LogDebug("Loading {0} files...", typeof(Bond).Name);
            Dictionary<string, string> chosenFiles = ResourceHelper.GetResources(assembly, prefix, "xml");
            if (chosenFiles.Count == 0)
