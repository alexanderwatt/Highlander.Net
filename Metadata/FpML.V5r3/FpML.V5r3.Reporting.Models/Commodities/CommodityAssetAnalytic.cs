...
namespace Orion.Models.Commodities
{
    ...
    /// </summary>
    public class CommodityAssetAnalytic : ModelAnalyticBase<ICommodityAssetParameters, CommodityMetrics>, ICommodityAssetResults
    {
        /// <summary>
        /// Gets the NPV.
        /// </summary>
        ...
        {
            return AnalyticParameters.CommodityForward;//TODO fix this.
        }
