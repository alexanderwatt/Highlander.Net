    ...
    public static class DataQualityValidator
    {
                                           ...
                                           bool throwException)
        {
            var isMinimumSatisfied =
                (valueToValidate.CompareTo(minimum) >=0 ? true:false);
        ...
        {
            var isPositive =
                (valueToValidate.CompareTo(0m) > 0 ? true : false);
        ...
        {
            var isPositive =
                (valueToValidate.CompareTo(0d) > 0 ? true : false);
        ...
        public static bool ValidateNonEmptyString(string stringToValidate,
                                                  ...
                                                  bool throwException)
        {
            var isEmptyString = (stringToValidate.Length == 0 ? true : false);
