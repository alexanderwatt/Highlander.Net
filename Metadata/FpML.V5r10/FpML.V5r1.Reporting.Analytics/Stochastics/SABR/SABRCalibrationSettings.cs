...
namespace Orion.Analytics.Stochastics.SABR
{
    ...
    public class SABRCalibrationSettings
    {
        ...
        /// Postcondition: private field _beta is set, provided that the input
        /// value beta is valid.
        /// </summary>
        ...
        public override bool Equals(object elt)
        {
            ...
            if (elt.GetType() == typeof (SABRCalibrationSettings))
            {
                ...
                eq = _instrument == b_instrument;
                eq = eq && _currency == b_currency;
                eq = eq && Beta == b_Beta;
            }
            return eq;
        }
        ...
        /// <summary>
        /// Three letter currency code, for example AUD, that can be used
        /// to identify the structure of the relevant market data used in
        /// the calibration of the SABR model. 
        /// </summary>
        private readonly string _currency;

        /// <summary>
        /// Name that identifies the SABR calibration settings object.
        /// </summary>
        private readonly string _handle;

        /// <summary>
        /// Instrument, for example Swaption, that can be used to identify
        /// the structure of the relevant market data used in the calibration
        /// of the SABR model. 
        /// </summary>
        private readonly InstrumentType.Instrument _instrument;
