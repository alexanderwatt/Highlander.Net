...
namespace Orion.Analytics.Stochastics.Volatilities
{
    ...
    /// The parameter constructor picks up a mtrix from a spreadsheet and populates the underlying FpML
    /// </summary>
    [Serializable]
    ...
    public class CapFloorATMMatrix : SABRDataMatrix
    {
        ...
        public string MatrixType
        {
            get
            {
                if (dataPoints == null || dataPoints.point == null || dataPoints.point[0].measureType == null)
                    return string.Empty;
                ...
                if (data[row][0] != null)
                {
                    ...
                    for (var column = 0; column < headers.Length; column++)
                    {
                        ...
                        if (column == expiry)
                        {
                            ...
                            point.coordinate[0].expiration[0] = new TimeDimension {Items = new[] {expiration}};
                        }
                        else if (column == atm)
                        {
        ...
        public string[] GetExpiries()
        {
            ...
            foreach (PricingStructurePoint point in dataPoints.point)
            {
                ...
                if (point.coordinate != null && point.coordinate[0].expiration != null && point.coordinate[0].expiration[0].Items != null)
                {
        ...
        public object[][] GetVolatilitySettings()
        {
            ...
            // Each setting is a seperate quote
