...
namespace Orion.Analytics.Stochastics.Volatilities
{
    ...
    public class CapFloorVolatilityMatrix : VolatilityMatrix
    {
        ...
        {
            get { return baseDate != null ? baseDate.Value : DateTime.MinValue; }
            set
            {
                baseDate = new IdentifiedDate {Value = value};
            }
        }
        ...
        /// <param name="discountFactors">The disount factor values</param>
        ...
        /// The curve is attached to this capfloor matrix
        /// </summary>
        ...
        private void GenerateVolatilityMatrix(string[] expiry, string[] volType, decimal[] strike, decimal[][] volatility)
        {
            ...
            var maxCols = strike != null ? strike.Length : 1;
            ...
            for (var row = 0; row < maxRows; row++)
            {
                ...
                for (var column = 0; column < maxCols; column++)
                {
                    ...
                    decimal? nullableStrike = strike != null ? strike[column] : (decimal?)null;
        ...
        {
            if (volatility < 0)
                throw new ArgumentException(string.Format("An illegal volatility value d: {0} found.",
                                                          volatility));
        ...
        private static Period CreateInterval(string p)
        {
            ...
            Period period = new Period
                                {
                                    periodMultiplier = numPart.ToString(),
