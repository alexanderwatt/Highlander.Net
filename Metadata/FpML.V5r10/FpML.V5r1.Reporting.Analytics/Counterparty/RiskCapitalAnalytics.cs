...
namespace Orion.Analytics.Counterparty
{
    ...
    public class RiskCapitalAnalytics
    {
        ...
        /// <param name="numStandDevs"></param>
        /// <param name="corEstimate"></param>
        /// <returns></returns>
        public decimal CalculateRiskCapital(decimal ul, decimal capAdjustFactor, decimal numStandDevs, decimal corEstimate)
        {
            var sqrtRho = (decimal) Math.Sqrt((double) corEstimate);
            
            //calculate CRC
            decimal crc = capAdjustFactor * numStandDevs * sqrtRho * ul;
