...
namespace Orion.Analytics.Helpers
{
    ...
    public static class DateTypesHelper
    {
        ...
        /// <returns></returns>
        static public PayRelativeToEnum GetPaymentRelativeTo(DiscountingTypeEnum discountingType)
        {
        ...
        /// <returns></returns>
        static public DateTime GetUnadjustedPaymentDate(DateTime unadjustedStartDate, DateTime unadjustedEndDate, PayRelativeToEnum payRelativeTo)
        {
            ...
            switch (payRelativeTo)
            {
                ...
                case PayRelativeToEnum.CalculationPeriodEndDate:
                    ...
                    break;
                default:
                    throw new ArgumentOutOfRangeException(string.Format("{0} Payment relative not supported!", payRelativeTo));
            }
        ...
        ///<returns></returns>
        static public AdjustableDate ToAdjustableDate(DateTime unadjustedStartDate, DateTime unadjustedEndDate, 
