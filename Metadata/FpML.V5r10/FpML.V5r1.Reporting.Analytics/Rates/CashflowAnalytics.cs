...
using Orion.Numerics.Optimization;
...
namespace Orion.Analytics.Rates
{
    ...
    public class CashflowAnalytics
    {
        ...
        public Decimal GetBucketedDelta1(decimal forwardRate)
        {
            ...
            var realFunction = new QRRealFunction(BucketedDeltaTargetFunction);

            var rate = forwardRate;
            var dRate = Decimal.ToDouble(rate);
            var delta = (Decimal)EONumericalDifferentiator.CentralDerivative(realFunction, dRate, out estimatedRate);
