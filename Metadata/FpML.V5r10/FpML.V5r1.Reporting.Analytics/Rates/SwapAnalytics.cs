...
namespace Orion.Analytics.Rates
{
    ...
    public class SwapAnalytics
    {
        ...
        static public double NPV(double[] notionals, double[] forwardRates, double[] paymentDiscountFactors, double[] yearFractions)
        {
        ...
        /// <returns>The break even rate.</returns>
        static public double NPVWithExchanges(double[] couponNotionals, double[] forwardRates,
        ...
        /// <param name="notionals">The notionals</param>
        /// <returns>The break even rate.</returns>
        static public double BreakEvenRate(double[] notionals, double[] forwardRates, double[] paymentDiscountFactors, double[] yearFractions)
        {
        ...
        /// <param name="principalPaymentDiscountFactors">The payment discount factors for the principal exchanges.</param>
        /// <returns>The break even rate.</returns>
        static public double BreakEvenRateWithExchanges(double[] couponNotionals, double[] forwardRates,
            double[] couponPaymentDiscountFactors, double[] yearFractions, double[] principalNotionals, 
            double[] principalPaymentDiscountFactors)
        {
            var result = 0.0;
        ...
        /// <returns>The break even rate.</returns>
        static public double Delta0(double[] notionals, double[] paymentDiscountFactors, double[] yearFractions, Boolean fixedFlag)
        {
        ...
        /// <returns>The break even rate.</returns>
        static public double Delta0WithExchanges(double[] notionals, double[] paymentDiscountFactors, double[] yearFractions, 
        ...
        /// <returns>The break even rate.</returns>
        static public double Delta1(double[] amounts, double[] paymentDiscountFactors,
        ...
        /// <param name="principalNotionals">The principal Exchanges.</param>
        /// <returns>The break even rate.</returns>
        static public double Delta1WithExchanges(double[] notionals, double[] paymentDiscountFactors,
