...
namespace Orion.Analytics.Interpolations.Spaces
{
    ...
    public class InterpolatedCurve : InterpolatedSpace
    {
        ...
        {
            _interpolation.Initialize(GetDiscreteSpace().GetCoordinateArray(1),GetDiscreteSpace().GetFunctionValueArray());
        }
        ...
        {
            return _interpolation.ValueAt((double) point.Coords[0], true);
        }
