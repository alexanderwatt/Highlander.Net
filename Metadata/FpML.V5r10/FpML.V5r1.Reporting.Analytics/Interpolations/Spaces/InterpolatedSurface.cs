...
namespace Orion.Analytics.Interpolations.Spaces
{
    ...
    public class InterpolatedSurface : InterpolatedSpace
    {
        ...
        /// </summary>
        protected readonly IInterpolation _yInterpolation;
        protected readonly IInterpolation _xInterpolation;
            ...
            : base(discreteSurface, interpolation, allowExtrapolation)
        {
            ...
            _yInterpolation = yInterpolation;
            _xInterpolation = interpolation;
      }
        ...
        public override double Value(IPoint point)
        {
            ...
            else
            {
                _interpolation.Initialize(xArray, fxArray);
                var xy = (double)point.Coords[0];
                xyValue = _interpolation.ValueAt(xy, true);
            }
            ...
            else
            {
                _interpolation.Initialize(yArray, fyArray);
                var yy = (double)point.Coords[0];
                yyValue = _interpolation.ValueAt(yy, true);
            }
            ...
            {
                _yInterpolation.Initialize(xyArray, yxArray);
                result = _yInterpolation.ValueAt((double)point.Coords[1], true);
            }
