...
namespace Orion.Analytics.BusinessCenters
{
    ...
    /// <item><description>Holy Thursday</description></item>
    ...
    /// <item><description>National Independence Day, May 17st</description></item>
    ...
    public sealed class Oslo : WesternCalendarBase
    {
        /// <summary>
        ...
        /// of this type.
        /// </remarks>
        [ Obsolete("Use Oslo.Instance in .NET applications.") ]
        public Oslo() 
            : base( "Oslo", CultureInfo.CreateSpecificCulture("no"))
            // not sure what they use in Norway: no, nb-NO, nn-NO
        {}
