...
namespace Orion.Analytics.BusinessCenters
{
    ...
    /// <item><description>Berchtoldstag, January 2nd</description></item>
    ...
    /// <item><description>National Day, August 1th</description></item>
    ...
    public sealed class Zurich : WesternCalendarBase
    {
        /// <summary>
        ...
        /// of this type.
        /// </remarks>
        [ Obsolete("Use Zurich.Instance in .NET applications.") ]
        public Zurich() 
            : base( "Zurich", CultureInfo.CreateSpecificCulture("fr-CH"))
            // alt. culture: de-CH
        {}
