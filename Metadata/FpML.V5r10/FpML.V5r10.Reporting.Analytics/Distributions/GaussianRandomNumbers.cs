...
namespace Orion.Analytics.Distributions
{
    ...
    /// normal distribution.
    /// The Box-Muller method is used to map a pair of uniformally distributed
    ...
    public class GaussianRandomNumbers
    {
        ...
        /// </summary>
        /// <param name="seed">Value used to seed the random number genetaor.
