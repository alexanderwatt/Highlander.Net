...
{
    /// <summary>
    /// Abstract base for a cached continous random number generator.
    /// </summary>
    /// <remarks>
    /// Derived classes must override and supply the concrete RNG 
    /// implementation in <see cref="Generate"/>.
    /// </remarks>
    public abstract class CachedContinousRng : IContinousRng

    {
        /// <summary>
        /// Initialize a cached continous RNG with the default _cache size (256 numbers).
        /// </summary>
        /// <overloads>
        /// Initialize a cached continous random number generator.
        /// </overloads>
        protected CachedContinousRng() : this(256)
        {}

        /// <summary>
        /// Initialize a cached continous RNG with the given _cache size..
        /// </summary>
        ...
        /// underlying library.
        /// </remarks>
        protected CachedContinousRng(int cacheSize)
        {
