    ...
    public static class Collection
    {
        ...
        public class ConcatCollection : ICollection
        {
            ...
            public class ConcatEnumerator : IEnumerator
            {
                ...
                private bool _isEnumator1Current;
                ...
                public object Current => _isEnumator1Current ? _enumerator1.Current : _enumerator2.Current;

                public bool MoveNext()
                {
                    if(_isEnumator1Current && _enumerator1.MoveNext()) return true;
        ...
        public static ICollection Minus(ICollection c1, ICollection c2)
        {
            ...
            if(c2 == null) throw new ArgumentNullException(nameof(c2),
                                                           "#E01 Substracted collection should not be null.");
