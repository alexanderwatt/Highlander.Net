...
namespace FpML.V5r10.Reporting.Analytics.Pedersen
{
    ...
    class Log : NodeFunction
    {
        ...
        public override double Evaluate(Node[] n)
        {
            ...
            if (n.Length == 1)
            {
                return System.Math.Log10(n0);
            }
            double n1 = n[1].Evaluate();
            return System.Math.Log(n0, n1);
        }
    }
    ...
    class SwapRate : NodeFunction
    {
        ...
        public override double Evaluate(Node[] n)
        {
            if (n.Length < 2)
            {
                throw new System.Exception("!! Swap rate requires an expiry and a tenor.");
            }
            double n0 = n[0].Evaluate();
            double n1 = n[1].Evaluate();
            if (n.Length == 2)
