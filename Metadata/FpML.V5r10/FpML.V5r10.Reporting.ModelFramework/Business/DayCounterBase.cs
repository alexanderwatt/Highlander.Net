...
namespace FpML.V5r10.Reporting.ModelFramework.Business
{
    /// <summary>
    ...
    /// </summary>
    /// <unittest>Orion.Business.Tests.TestDayCounters.TestActualActual</unittest>
    public abstract class DayCounterBase : IDayCounter 
    {
        ...
        public int DayCount(DateTime startDate, DateTime endDate) 
        {
            ...
            return 360 * (endDate.Year - startDate.Year) + 30*(mm2 - mm1 -1) + System.Math.Max(0, 30 - dd1) + System.Math.Min(30, dd2);
        }

        /// <summary>
        /// Returns the period between two dates as a fraction of year. Start date after end date generates negative year fractions.
        /// </summary>
