...
namespace FpML.V5r10.Reporting.ModelFramework.Instruments
{
    ...
    /// </summary>
    [Serializable]
    public abstract class InstrumentControllerBase : IModelController<IInstrumentControllerData, AssetValuation>, IProduct // ReporterBase,  -> move this to here!
    {
        #region Constants
        ...
        //public IList<DateTime> BucketedDates { get; set; }

        /// <summary>
        /// Gets the bucketed dates list.
        /// </summary>
        /// <value>The bucketed dates list.</value>
        public string BucketedDatesList
        {
            get
            {
                return string.Join(",", BucketedDates.Select(date => date.ToString("yyyy-MM-dd")).ToArray());
            }
        }
        /// <summary>
        ...
        /// <returns></returns>
        protected static List<AssetValuation> EvaluateChildMetrics<FpmLT, ParentMetricEnumT, ChildModelParamsT, ChildMetricEnumT>(List<IPriceableInstrumentController<FpmLT>> childControllers, IInstrumentControllerData modelData, IList<string> requestedMetrics, List<ParentMetricEnumT> parentMetrics, out List<ChildMetricEnumT> childMetrics, out List<string> childMetricsList)
        {
        ...
        ///// <returns></returns>
        //static public Decimal SumDecimals(Decimal[] list)
        //{
        //    Decimal total = 0.0m;
        ...
        ///// <returns></returns>
        //static public AssetValuation CreateAssetValuation(string[] metrics, DateTime baseDate)
        //{
