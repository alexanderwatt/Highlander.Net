...
namespace FpML.V5r10.Reporting.ModelFramework.Calibrators.Bootstrappers
{
    ...
    /// 
    /// </summary>
    public abstract class PriceableEquityAssetBootstrapController : IBootstrapPriceableEquityAssetController<IBootstrapControllerData, IPricingStructure>
    {
        ///<summary>
        ///</summary>
        ...
        /// <returns></returns>
        public abstract IPricingStructure Calculate(IBootstrapControllerData bootstrapData, IPriceableEquityAssetController[] priceableAssets);
