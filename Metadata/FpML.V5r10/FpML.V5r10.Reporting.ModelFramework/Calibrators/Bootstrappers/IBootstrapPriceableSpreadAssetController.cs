...
namespace FpML.V5r10.Reporting.ModelFramework.Calibrators.Bootstrappers
{
    ...
    public interface IBootstrapPriceableSpreadAssetController<D, R> : IBootstrapController<D, R>
    {
        /// <summary>
        ...
        /// <returns></returns>
        R Calculate(D bootstrapData, IPriceableSpreadAssetController[] priceableAssets);
    }
}