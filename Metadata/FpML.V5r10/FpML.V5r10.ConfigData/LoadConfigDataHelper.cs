...
namespace FpML.V5r10.ConfigData
{
    public static class LoadConfigDataHelper
    {
        ...
        public static void LoadCalendarConfigurationData(ILogger logger, ICoreCache targetClient, string nameSpace)
        {
        ...
        public static void LoadCurveConfigurationData(ILogger logger, ICoreCache targetClient, string nameSpace)
        {
