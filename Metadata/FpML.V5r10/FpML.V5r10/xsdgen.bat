    ...
    set xsd_options=/c /n:FpML.V5r10.Codelist Codelist.xsd
    call :call_xsd
    set xsd_options=/c /n:FpML.V5r10.Confirmation Confirmation.xsd xmldsig-core-schema.xsd
    call :call_xsd
    set xsd_options=/c /n:FpML.V5r10.Reporting Reporting.xsd xmldsig-core-schema.xsd
    call :call_xsd
