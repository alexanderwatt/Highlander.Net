    ...
    public class ProductTypeHelper
    {
        ...
        public static class PartyFactory
        {
            ...
            public static Party Create(string id, string partyName)
            {
                ...
                partyOrTradeSideReference.Items = new object[] {party};
                return partyOrTradeSideReference;
            }
        }
        ...
        public class XiborNodeStructHelper
        {
                ...
                string dateRelativeTo)
            {
                ...
                instrument.SpotDate = RelativeDateOffsetHelper.Create(spotDays, dayType, spotBusinessDayConvention,
                    spotBusinessCenters, dateRelativeTo);
                return instrument;
            }
        }
        ...
        public class InstrumentNodeHelper
        {
                ...
                string dateRelativeTo)
            {
                ...
                var instrument = new XiborNodeStruct
                {
                    ...
                    RateIndex =
                        RateIndexHelper.Parse(floatingRateIndex, currency,
                            dayCountFraction),
                    SpotDate = RelativeDateOffsetHelper.Create(spotDays, dayType, spotBusinessDayConvention,
                        spotBusinessCenters, dateRelativeTo)
                };
                return instrument;
            }
                ...
                string fraDiscounting)
            {
                ...
                fra.fixedRate = new IdentifiedRate {Value = fixedRate};
                ...
                string resetDateRelativeTo)
            {
                ...
                var instrument = new RateOptionNodeStruct
                {
                    ...
                    SpotDate = RelativeDateOffsetHelper.Create(spotDays, dayType, spotBusinessDayConvention,
                        spotBusinessCenters, dateRelativeTo),
                    ResetDateAdjustment = RelativeDateOffsetHelper.Create(resetDays, resetDayType,
                        resetBusinessDayConvention, resetBusinessCenters, resetDateRelativeTo),
                ...
                string dateRelativeTo)
            {
                ...
                var irswap = SimpleIrsHelper.Parse(instrumentId, currency, dayCountFraction, term, paymentFrequency,
                    assetId);
                ...
                Boolean includeFirstCaplet)
            {
                ...
                var money = MoneyHelper.GetAmount(notional, currency);
                var dayCount = DayCountFractionHelper.Parse(dayCountFraction);
                var irCap = SimpleIrsHelper.Parse(instrumentId, currency, dayCountFraction, term, paymentFrequency,
                    assetId);
                ...
                string exDivDateRelativeTo)
            {
                ...
                var bond = BondHelper.Parse(instrumentId, clearanceSystem, couponType, couponRate, currency, notional,
                    maturity,
                ...
                var instrument = new BondNodeStruct
                {
                    BusinessDayAdjustments =
                        BusinessDayAdjustmentsHelper.Create(businessDayConvention, businessCenters),
                    ExDivDate = RelativeDateOffsetHelper.Create(exDivDays, exDayType, exDivBusinessDayConvention,
                        exDivBusinessCenters, exDivDateRelativeTo),
                    SettlementDate = RelativeDateOffsetHelper.Create(settlementDays, dayType,
                        settlementBusinessDayConvention, settlementBusinessCenters, dateRelativeTo),
                    Bond = bond
                };
                return instrument;
            }
        ...
        public class InstrumentHelper
        {
                ...
                XiborNodeStruct xibor)
            {
                var instrument = new Instrument
                    {AssetType = assetId, Currency = CurrencyHelper.Parse(currency), InstrumentNodeItem = xibor};
                return instrument;
            }
            ...
            {
                var instrument = new Instrument
                    {AssetType = assetId, Currency = CurrencyHelper.Parse(currency), InstrumentNodeItem = asset};
                return instrument;
            }
        ...
        public class FxSpotRateSourceHelper
        {
                ...
                string secondaryRateSourceProvider, string secondaryRateSourcePage, string secondaryRateSource)
            {
                var fxSpotRateSource = new FxSpotRateSource
                {
                    ...
                    primaryRateSource = InformationSourceHelper.Create(primaryRateSourceProvider, primaryRateSource,
                        primaryRateSourcePage),
                    secondaryRateSource = InformationSourceHelper.Create(secondaryRateSourceProvider,
                        secondaryRateSourcePage, secondaryRateSource),
                };
        ...
        {
            public static RateObservation Parse(DateTime adjustedFixingDate, Decimal observedRate,
            ...
            public static RateObservation Parse(DateTime adjustedFixingDate, Decimal? observedRate,
                string observationWeight)
            {
                RateObservation result = observedRate != null
                    ? new RateObservation
                    {
                        adjustedFixingDate = adjustedFixingDate,
                        adjustedFixingDateSpecified = true,
        ...
        public class PropertyAssetHelper
        {
            ...
            /// <returns></returns>
            public static PropertyAsset Create(string propertyId, string propertyType, string streetIdentifier,
                string streetName,
                string suburb, string city, string state, string country, int numBedrooms, int numBathrooms,
                int numParking, string currency, string description)
            {
        ...
        public class CommodityAverageSwapHelper
        {
            public static CommodityAverageSwapNodeStruct Create(string commodityType, string commodityDetails,
                ...
                decimal conversionFactor, Rounding rounding, CommodityPricingDates pricingDates, CommodityFx fx,
                object[] commoditySpreadArray)
            {
