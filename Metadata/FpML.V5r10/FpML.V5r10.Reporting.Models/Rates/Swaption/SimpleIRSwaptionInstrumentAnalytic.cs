    ...
    public class SimpleIRSwaptionInstrumentAnalytic : ModelAnalyticBase<ISwaptionInstrumentParameters, SwaptionInstrumentMetrics>, ISwaptionInstrumentResults
    {
        ...
        public Decimal NPV
        {
            get 
            {
                ...
                if (AnalyticParameters.IsBought) return result + System.Math.Abs(AnalyticParameters.SwapAccrualFactor) * EvaluateOptionPremium() * 10000;
                return result + System.Math.Abs(AnalyticParameters.SwapAccrualFactor) * EvaluateOptionPremium() * -10000; 
            }
        }
        ...
        protected Decimal CalculateOptionStrike()
        {
            ...
            //{
                var premium = System.Math.Abs(AnalyticParameters.OtherNPV) / System.Math.Abs(AnalyticParameters.SwapAccrualFactor)/ 10000;
