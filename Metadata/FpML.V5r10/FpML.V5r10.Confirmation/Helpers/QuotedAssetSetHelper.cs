...
{
    public class QuotedAssetSetHelper
    {
        ...
        public QuotedAssetSet Create()
        {
            ...
            var instrumentSet = new InstrumentSet {Items = assets.ToArray()};
        ...
        public static Pair<Asset, BasicAssetValuation> Parse(string instrumentId, decimal value, decimal adjustment)
        {
            ...
            switch (instrument)
            {
                ...
                case "OIS":
                    {
                        var tenor = results[2];
                        var rateIndex = new RateIndex { id = instrumentId, term = Period.Parse(tenor) };
                ...
                case "SimpleIRSwap":
                    {
                        var simpleIRSwap = new SimpleIRSwap { id = instrumentId, term = Period.Parse(results[2]) };
                ...
                case "BankBill":
                    {
                        var deposit = new Deposit { id = instrumentId, term = Period.Parse(results[2]) };
                ...
                case "SpreadFra":
                    {
                        var index = results[3];
                        var asset = new SimpleFra { id = instrumentId, startTerm = Period.Parse(results[2]) };
                ...
                case "IRCap":
                    {
                        var simpleIRCap = new SimpleIRSwap { id = instrumentId, term = Period.Parse(results[2]) };
            ...
            for (var i = 0; i < instrumentIds.Length; i++)
            {
                ...
                switch (instrument)
                {
                    ...
                    case "OIS":
                        {
                            var tenor = results[2];
                            underlyingAsset = new RateIndex { id = instrumentId, term = Period.Parse(tenor) };
                            listBasicQuotations.Add(BasicQuotationHelper.Create(rateQuotationType, priceUnitDecimalRate));
                            break;
                        }
                    case "IRSwap":
                    ...
                    case "SimpleIRSwap":
                        {
                            underlyingAsset = new SimpleIRSwap { id = instrumentId, term = Period.Parse(results[2]) };
                            listBasicQuotations.Add(BasicQuotationHelper.Create(rateQuotationType, priceUnitDecimalRate));
                            break;
                        }
                    case "Deposit":
                    ...
                    case "BankBill":
                        {
                            underlyingAsset = new Deposit { id = instrumentId, term = Period.Parse(results[2]) };
                            listBasicQuotations.Add(BasicQuotationHelper.Create(rateQuotationType, priceUnitDecimalRate));
                            break;
                        }
                    case "SimpleFra":
