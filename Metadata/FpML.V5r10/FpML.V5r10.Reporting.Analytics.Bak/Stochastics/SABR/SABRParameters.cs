...
namespace Orion.Analytics.Stochastics.SABR
{
    ...
    public class SABRParameters
    {
        ...
        /// false.</returns>
        static public bool CheckSABRParameterAlpha(decimal alpha,
        ...
        /// false.</returns>
        static public bool CheckSABRParameterBeta(decimal beta,
                                                  ref string errorMessage)
        {
            // Initialise the return variable.
            var isParameterValid = true;
        ...
        /// false.</returns>
        static public bool CheckSABRParameterNu(decimal nu,
                                                ref string errorMessage)
        {
            // Initialise the return variable.
            var isParameterValid = true;
        ...
        /// false.</returns>
        static public bool CheckSABRParameterRho(decimal rho,
                                                 ref string errorMessage)
        {
            // Initialise the return variable.
            var isParameterValid = true;
        ...
        /// false.
        /// </returns>
        static public bool CheckSABRParameters(SABRParameters sabrParameters,
                                               ref string errorMessage)
        {
