...
namespace Orion.Analytics.Rates
{
    ...
    public class FloatingPaymentStream: PaymentStream
    {
                                  ...
                                  )
        {
            ...
            _forwardRates = CalculateForwardRates(discountFactors, accrualFactors);
        ...
        public List<decimal> ForwardRates
        {
            get { return _forwardRates; }
        } 
        ...
        private readonly List<decimal> _forwardRates;
