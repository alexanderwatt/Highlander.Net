...
namespace Orion.Analytics.Interpolations.Points
{
    ...
    public class Coordinate : IPoint
    {
        ...
        ///<summary>
        ///</summary>
        public Point ContainedPoint { get; private set; }

        ///<summary>
        ///</summary>
        public PricingDataPointCoordinate PricingDataCoordinate { get; private set; }
        ...
        {
            get { return ContainedPoint.FunctionValue; }
