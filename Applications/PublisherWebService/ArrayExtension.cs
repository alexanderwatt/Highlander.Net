...
namespace Orion.PublisherWebService
{
    ...
    {
        static public object[,] ConvertArrayToMatrix(this object[][] inputArray)
        {
        ...
        static public double[,] ConvertArrayToMatrix(this double[][] inputArray)
        {
            int c1 = inputArray.Length;
            int c2 = inputArray[inputArray.GetLowerBound(0)].Length;
        ...
        static public T[] ConvertToOneDimensionalArray<T>(this object[][] inputArray)
        {
        ...
        static public NamedValueSet ToNamedValueSet(this object[][] inputArray)
        {
            int c1 = inputArray.Length;
            int c2 = inputArray[inputArray.GetLowerBound(0)].Length;
