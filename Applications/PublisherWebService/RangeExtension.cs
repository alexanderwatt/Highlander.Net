...
namespace Orion.PublisherWebService
{
    ...
    internal static class RangeExtension
    {
        ...
        /// <returns></returns>
        static public object[] GetRow(this object[,] rawData, int rowNumber)
        {
        ...
        /// <returns></returns>
        static public object[] GetRow(this object[,] rawData, int rowNumber, int startColumn, int endColumn)
        {
            int cols = rawData.GetUpperBound(1) + 1;
            int rows = rawData.GetUpperBound(0) + 1;
            var items = new List<object>();
        ...
        /// <returns></returns>
        static public object[] GetColumn(this object[,] rawData, int columnNumber)
        {
            int cols = rawData.GetUpperBound(1) + 1;
            int rows = rawData.GetUpperBound(0) + 1;
            var items = new List<object>();
        ...
        static public void SetColumn(this object[,] rawData, int columnNumber, object[] values)
        {
            int cols = rawData.GetUpperBound(1) + 1;
            int rows = rawData.GetUpperBound(0) + 1;
            if (columnNumber <= cols)
        ...
        /// <returns></returns>
        static public object[][] GetRows(this object[,] rawData, int startRow, int endRow)
        {
        ...
        /// <param name="endColumn">The end column.</param>
        /// <returns></returns>
        static public object[][] GetRows(this object[,] rawData, int startRow, int endRow, int startColumn, int endColumn)
        {
            int rowIndex = 0;
        ...
        /// <param name="rawData">The raw data.</param>
        /// <returns></returns>
        static public int RowCount(this object[,] rawData)
        {
        ...
        /// <param name="rawData">The raw data.</param>
        /// <returns></returns>
        static public int ColumnCount(this object[,] rawData)
        {
        ...
        /// <returns></returns>
        static public object[][] ValueAsArray(this object[,] vals)
        {
