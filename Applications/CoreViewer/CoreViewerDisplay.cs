...
namespace CoreViewer 
{
    public partial class CoreViewerForm : Form
    {
        ...
        private void DisplayItemInNavDetail(ICoreItem item)
        {
            ...
            LogNavDetail(String.Format("  AppProps  :"));
            item.AppProps.LogValues(text => LogNavDetail("    " + text));
            //  dump system propeties
...
*/
        ...
        {
            var tag = e.Node.Tag as ICoreItem;
            if (tag != null)
            {
                var item = tag;
                DisplayItemInNavDetail(item);
        ...
        {
            var itemToSave = treeNavigation.SelectedNode?.Tag as ICoreItem;
            if (itemToSave == null)
                return;
        ...
        private void ViewXmlStripMenuItemClick(object sender, EventArgs e)
        {
            ...
            //Load the form
            //
            var xmlTreeDisplay = new XmlTreeDisplay(itemToValue);
        ...
        private void LoadLocalTradeData(ILogger logRef, ICoreCache targetClient, String nameSpace)
        {
            ...
            var data = document as DataDocument;
            if (data != null)
            {
                var tradeData = data;
        ...
        //private static NamedValueSet MakeTradeProps(Trade trade)
        //{
        //    var itemProps = new NamedValueSet();
        //    itemProps.Set(TradeProp.DataGroup, "Orion.Trade");
        //    itemProps.Set("SourceSystem", "File");
        //    itemProps.Set("Function", "Trade");
        //    itemProps.Set("Type", "Trade");
        //    var party1 = trade..partyTradeIdentifier[0].partyReference.href;
        //    var party2 = trade.tradeHeader.partyTradeIdentifier[0].partyReference.href;
        //    itemProps.Set(TradeProp.Party1, party1);
        //    itemProps.Set(TradeProp.Party2, party2);
        //    itemProps.Set(TradeProp.TradeState, "Pricing");
        //    //extraProps.Set("TradeType", "Deposit");
        //    itemProps.Set(TradeProp.TradeSource, "FPMLSamples");
        //    itemProps.Set(TradeProp.TradeId, trade.id);
        //    itemProps.Set(TradeProp.BaseParty, party1);
        //    itemProps.Set(TradeProp.CounterPartyName, party2);
        //    itemProps.Set(TradeProp.AsAtDate, DateTime.Today);
        //    var tradeType = ProductTypeHelper.TradeTypeHelper(trade.Item);
        //    string itemName = "Orion.Trade." + tradeType + "." + trade.id;
        ...
        //    itemProps.Set(TradeProp.RequiredPricingStructures, curves);
        //    itemProps.Set(TradeProp.RequiredCurrencies, currencies);
        //    itemProps.Set(TradeProp.TradeType, tradeType.ToString());
        //    //itemProps.Set(TradeProp.ProductType, tradeType.ToString());
        ...
        private void BtnLoadTradeClick(object sender, EventArgs e)
        {
            using (Reference<ILogger> logRef = Reference<ILogger>.Create(new ConsoleLogger("LoadLocalTradeData: ")))
            {
                ...
                try
                {
                    ...
                    //    {
                    //        client.DeleteUntypedObjects(null, Expr.StartsWith(Expr.SysPropItemName, "Orion.Configuration."));
                    //    }
                        ...
                        LoadLocalTradeData(logRef.Target, _client, EnvironmentProp.DefaultNameSpace);//TODO Make the namespace a variable.
                        // done
        ...
        //        {
        //            // load configuration data
        //            AppSettingsLoader.Load(logRef.Target, _Client);
        //            LoadConfigDataHelper.LoadConfigurationData(logRef.Target, _Client);
        //            // done
        //            logRef.Target.LogInfo("Success");
        //            //}
        //        }
