...
namespace PublisherWebService.Tests
{
    ...
    public class CurveCalQ
    {
        ...
        private const string RateCurveIndexName = "AUDSwap";
        ...
        private string CreateTraderMid3M()
        {
            ...
            Assert.AreEqual("Orion.Market.TraderMid.RateCurve.AUD-LIBOR-BBA-3M", actual);
        ...
        public void TraderMid1MTest()
        {
            ...
            // Publish via web service
            var actual = Ps.PublishCurve(rateCurveProperties, publishProperties, rateCurveValues);
            Assert.AreEqual("Orion.Market.TraderMid.RateCurve.AUD-LIBOR-BBA-1M", actual);
        ...
        public void PublishSwaptionVolTest()
        {
            ...
            Assert.AreEqual("Orion.Market.Live.RateATMVolatilityMatrix.AUD-LIBOR-BBA-Swaption", actualId);
        ...
        public void PublishCapFloorVolTest()
        {
            ...
            Assert.AreEqual("Orion.Market.Live.RateVolatilityMatrix.AUD-LIBOR-BBA-CapFloor", actualId);
            var market = Ps.GetCurve(actualId, false);
            Market fpml = market.GetMarket();
            string actual = XmlSerializerHelper.SerializeToString(fpml);
            ...
            = new[]
                  {
                      ...
                      new object[] {"ReferenceCurveUniqueId", 
                          string.Format("Orion.Market.{0}.RateCurve.{1}-{2}-3M", RateCurveMarketName, Currency, RateCurveIndexName)},
                      // Following property is here so that data doesn't change
                      // not needed in actual sheet
                      new object[] {"BaseDate", new DateTime(2009, 12, 18)},
                      new object[] {"BuildDateTime", new DateTime(2009, 12, 18, 13, 18, 26)}
        ...
        public void PublishLpmCurve3MTest()
        {
            ...
            Assert.AreEqual("Orion.Market.LiveUnitTest.RateCurve.AUD-AUDSwap-3M", result);
        ...
        public void PublishLpmCurve6MTest()
        {
            ...
            Assert.AreEqual("Orion.Market.LiveUnitTest.RateCurve.AUD-AUDSwap-6M", result);
        ...
        public void PublishLpmCurveBondFuturesTest()
        {
            ...
            Assert.AreEqual("Orion.Market.LiveUnitTest.RateCurve.AUD-BondFuturesPay-310Y", result);
            ...
            object[][] values =
                {
                    ...
                    new object[] {"15Y", 6.80, "Cap/Floor"},
                    new object[] {"20Y", 6.55, "Cap/Floor"},
                    new object[] {"25Y", 6.30, "Cap/Floor"},
                    new object[] {"30Y", 6.05, "Cap/Floor"},
                    new object[] {null, null, null}
                };

            // publish the matrix
            string result = Ps.PublishLpmCapFloorVolMatrix(matrixProperties, matrixPublishProperties, values, RateCurveProperties3M);
            Debug.Print(result);
            Assert.AreEqual(marketName + ".Volatility.CapFloor.AUD.SydSPU.2009.Week51", result);
