...
namespace Orion.CalendarEngine.Schedulers
{
    ...
    public static class AdjustedDateScheduler
    {
        ...
        /// <param name="nameSpace">The cliens namespace</param>
        /// <returns></returns>
        public static List<DateTime> GetAdjustedDateSchedule(ICoreCache cache, DateTime effectiveDate, Period intervalToTerminationDate,
        Period periodInterval, BusinessDayAdjustments businessDayAdjustments, string nameSpace)
        {
        ...
        ///// <returns></returns>
        //static public List<DateTime> GetAdjustedDateSchedule(DateTime[] unadjustedPeriodDates, BusinessDayConventionEnum businessDayConvention, IBusinessCalendar paymentCalendar)
        //{
        //    IEnumerable<DateTime> adjustedPeriodDates
