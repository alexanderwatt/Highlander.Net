...
using FpML.V5r10.Reporting.Models.ForeignExchange.FxOption;
using FpML.V5r10.Reporting.Models.ForeignExchange.FxOptionLeg;
...
namespace Orion.ValuationEngine.Pricers.Products
{
    ...
    public class VanillaEuropeanFxOptionPricer : InstrumentControllerBase, IPriceableFxLeg<IFxOptionLegParameters, IFxOptionLegInstrumentResults>, IPriceableInstrumentController<FxOption>
    {
        ...
        /// The FaceOnCurrency.
        /// </summary>
        public string FaceOnCurrency { get; set; }

        /// <summary>
        /// The OptionOnCurrency.
        /// </summary>
        public string OptionOnCurrency { get; set; }
        ...
        /// <summary>
        /// Gets the put currency party reference.
        /// </summary>
        /// <value>The seller party reference.</value>
        public string PutCurrencyPartyReference { get; set; }
        ...
        /// <summary>
        /// Gets the call currency party reference.
        /// </summary>
        /// <value>The buyer party reference.</value>
        public string CallCurrencyPartyReference { get; set; }
