...
namespace Highlander.Core.Common.Encryption
{
    ...
    public interface ICryptoManager
    {
        ...
        void SetTransportKey(string id, string transpKey);
    ...
    public class DefaultCryptoManager : ICryptoManager
    {
        ...
        public string GetTransportKey(string id)
        {
            ...
            return _keyCache.TryGetValue(id, out var keys) ? keys.TranspKey : null;
        }
        ...
        public string GetPublicKey(string id)
        {
            if (id == null)
                throw new ArgumentNullException(nameof(id));
            return _keyCache.TryGetValue(id, out var keys) ? keys.PublicKey : null;
        }
        ...
        public string GetSecretKey(string id)
        {
            if (id == null)
                throw new ArgumentNullException(nameof(id));
            return _keyCache.TryGetValue(id, out var keys) ? keys.SecretKey : null;
        }
        ...
        public byte[] EncryptWithTransportKey(string id, byte[] buffer)
        {
            ...
            switch (keys.Alg)
            {
                ...
                default:
                    throw new ArgumentException("Unknown alg: " + keys.Alg);
            }
        }
