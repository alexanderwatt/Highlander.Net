...
namespace Highlander.Core.Common
{
    ...
    public static class V341Helpers
    {
        public static V341ItemKind ToV341ItemKind(ItemKind itemKind)
        {
            return itemKind switch
            {
                ItemKind.Undefined => V341ItemKind.Undefined,
                ItemKind.Object => V341ItemKind.Object,
                ItemKind.System => V341ItemKind.System,
                ItemKind.Signal => V341ItemKind.Event,
                ItemKind.Debug => V341ItemKind.Debug,
                ItemKind.Local => V341ItemKind.Local,
                _ => throw new ArgumentException($"Unknown ItemKind: {itemKind}")
            };
        }
        public static ItemKind ToItemKind(V341ItemKind itemKind)
        {
            return itemKind switch
            {
                V341ItemKind.Undefined => ItemKind.Undefined,
                V341ItemKind.Object => ItemKind.Object,
                V341ItemKind.System => ItemKind.System,
                V341ItemKind.Event => ItemKind.Signal,
                V341ItemKind.Debug => ItemKind.Debug,
                V341ItemKind.Local => ItemKind.Local,
                _ => throw new ArgumentException($"Unknown V341ItemKind: {itemKind}")
            };
        }
    }
