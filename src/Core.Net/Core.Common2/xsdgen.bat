    ...
    rem --------------- main ---------------
    set _ns=Highlander.Core.Common
    call :gen  CoreObjects
    call :gen  AppCfgRuleV2Format
    call :gen  DebugFormat
    call :gen  ConnectionFormat
    call :gen  SubscriptionFormat
    call :gen  EnvConfigRuleFormat
    rem ------------------------------------
