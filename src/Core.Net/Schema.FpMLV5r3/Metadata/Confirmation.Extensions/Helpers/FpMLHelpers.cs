...
namespace nab.QDS.FpML.V47
{
    ...
    {
        public static ItemChoiceType16 TradeTypeHelper(Product product)
        {
            if (product as Swap != null) return ItemChoiceType16.swap;
            if (product as TermDeposit != null) return ItemChoiceType16.termDeposit;
            if (product as BulletPayment != null) return ItemChoiceType16.bulletPayment;
            if (product as BondOption != null) return ItemChoiceType16.bondOption;
            if (product as BrokerEquityOption != null) return ItemChoiceType16.brokerEquityOption;
            if (product as CapFloor != null) return ItemChoiceType16.capFloor;
            if (product as CommodityForward != null) return ItemChoiceType16.commodityForward;
            if (product as CommodityOption != null) return ItemChoiceType16.commodityOption;
            if (product as CommoditySwap != null) return ItemChoiceType16.commoditySwap;
            if (product as CorrelationSwap != null) return ItemChoiceType16.correlationSwap;
            if (product as CreditDefaultSwap != null) return ItemChoiceType16.creditDefaultSwap;
            if (product as CreditDefaultSwapOption != null) return ItemChoiceType16.creditDefaultSwapOption;
            if (product as DividendSwapTransactionSupplement != null) return ItemChoiceType16.dividendSwapTransactionSupplement;
            if (product as EquityForward != null) return ItemChoiceType16.equityForward;
            if (product as EquityOption != null) return ItemChoiceType16.equityOption;
            if (product as EquityOptionTransactionSupplement != null) return ItemChoiceType16.equityOptionTransactionSupplement;
            if (product as ReturnSwap != null) return ItemChoiceType16.equitySwap;
            if (product as EquitySwapTransactionSupplement != null) return ItemChoiceType16.equitySwapTransactionSupplement;
            if (product as Fra != null) return ItemChoiceType16.fra;
            if (product as FxAverageRateOption != null) return ItemChoiceType16.fxAverageRateOption;
            if (product as FxBarrierOption != null) return ItemChoiceType16.fxBarrierOption;
            if (product as FxDigitalOption != null) return ItemChoiceType16.fxDigitalOption;
            if (product as FxOptionLeg != null) return ItemChoiceType16.fxSimpleOption;
            if (product as FxLeg != null) return ItemChoiceType16.fxSingleLeg;
            if (product as FxSwap != null) return ItemChoiceType16.fxSwap;
            //if (product as ReturnSwap != null) return ItemChoiceType16.returnSwap;
            if (product as Strategy != null) return ItemChoiceType16.strategy;
            if (product as Swaption != null) return ItemChoiceType16.swaption;
            if (product as VarianceOptionTransactionSupplement != null) return ItemChoiceType16.varianceOptionTransactionSupplement;
            if (product as VarianceSwap != null) return ItemChoiceType16.varianceSwap;
            if (product as VarianceSwapTransactionSupplement != null) return ItemChoiceType16.varianceSwapTransactionSupplement;
            return ItemChoiceType16.swap;
        }
    ...
    public class PartyTradeIdentifierHelper
    {
        ...
        {
            var result = new PartyTradeIdentifier {partyReference = PartyReferenceHelper.Parse(partyReference)};
            var temp = new object[1];
            temp[0] = TradeIdHelper.Parse(tradeId);
            result.Items = temp;
            return result;
        }
    }
