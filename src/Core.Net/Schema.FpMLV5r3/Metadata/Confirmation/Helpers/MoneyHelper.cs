...
namespace FpML.V5r3.Confirmation
{
    public class MoneyHelper
    {
        ...
        public static NonNegativeMoney GetNonNegativeAmount(double amount, string currencyAsString)
        {
            ...
            var money = new NonNegativeMoney { currency = currency, amount = System.Math.Abs((decimal)amount) };
            return money;
        }
        ...
        {
            var currency = new Currency { Value = currencyAsString };
            var money = new NonNegativeMoney { currency = currency, amount = System.Math.Abs(amount) };
            return money;
        }
