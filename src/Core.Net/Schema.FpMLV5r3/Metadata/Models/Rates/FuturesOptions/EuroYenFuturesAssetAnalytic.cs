...
{
    public class EuroYenFuturesAssetAnalytic : ModelAnalyticBase<IFuturesAssetParameters, RateMetrics>, IRateAssetResults
    {
        ...
        {
            return AnalyticParameters.Position * (AnalyticParameters.Rate - ImpliedQuote) * 2500m;
        ...
        {
            return AnalyticParameters.Position * 2500m;
        }
