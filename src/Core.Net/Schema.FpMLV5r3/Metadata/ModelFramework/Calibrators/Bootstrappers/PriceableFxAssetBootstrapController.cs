...
namespace Orion.ModelFramework.Calibrators.Bootstrappers
{
    ...
    /// 
    /// </summary>
    abstract public class PriceableFxAssetBootstrapController : IBootstrapPriceableFxAssetController<IBootstrapControllerData, IPricingStructure>
    {
        ///<summary>
        ///</summary>
        ...
        /// <returns></returns>
        abstract public IPricingStructure Calculate(IBootstrapControllerData bootstrapData, IPriceableFxAssetController[] priceableAssets);
