...
using AlertRule = Highlander.Metadata.Common.AlertRule;
using AlertSignal = Highlander.Metadata.Common.AlertSignal;
...
namespace Highlander.Configuration.Data.V5r3
{
    public static class AlertRulesLoader
    {
        ...
        public static void Load(ILogger logger, ICoreCache targetClient, string nameSpace)
        {
            ...
            var defaultCheckConstraint = Expr.BoolAND(
            ...
            var defaultMonitorPeriod = TimeSpan.FromMinutes(1);
            // - publish period: hourly
            var defaultPublishPeriod = TimeSpan.FromHours(1);
            // build rules
            ...
            //const string prefix = "Highlander.Configuration.Data.V5r3.AlertRules";
                ...
                = new List<AlertRule>
                      {
                          MakeAlertRule(
                              ...
                              new NamedValueSet(new[]
                                                    {
                                                        new NamedValue("BaseDate", new DateTime(2019, 10, 1)),
                                                        new NamedValue("MailHost", "localhost:2525"),
                ...
                = new List<AlertRule>
                      {
                          MakeAlertRule(
                              ...
                              new NamedValueSet(new[] {new NamedValue("BaseDate", new DateTime(2019, 10, 1))}),
                              defaultMonitorPeriod,
                              defaultPublishPeriod,
                              $"Cartoo EOD curves ({env}) have not been published today."
                          ),
                          MakeAlertRule(
                              ...
                              defaultMonitorPeriod,
                              defaultPublishPeriod,
                              $"TraderMid ({env}) curve is out of date."
                          ),
                          MakeAlertRule(
