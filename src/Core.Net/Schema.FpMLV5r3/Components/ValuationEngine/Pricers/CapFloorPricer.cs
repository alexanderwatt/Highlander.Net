...
using Highlander.Reporting.Models.V5r3.Rates.CapFloor;
...
namespace Highlander.ValuationEngine.V5r3.Pricers
{
    public class CapFloorPricer : SwapPricer, IPriceableInstrumentController<CapFloor>
    {
            ...
            )
        {
            ...
            string valuationReportAndProductId = nameSpace + "." + tradeRange.Id;
            ...
            {
                if (string.IsNullOrEmpty(curveName)) continue;
