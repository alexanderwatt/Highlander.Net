...
namespace Highlander.Equities.Helpers
{
    /// <summary>
    ...
    public static class InputValidator
    {
        ...
        /// <param name="throwError">if set to <c>true</c> [throw error].</param>
        /// <returns></returns>
        internal static bool NotNull(string fieldName, object fieldValue, bool throwError)
        {
            bool isNull;
        ...
        /// <param name="throwError">if set to <c>true</c> [throw error].</param>
        /// <returns></returns>
        internal static bool DateNotNull(string fieldName, DateTime fieldValue, bool throwError)
        {
