...
using Highlander.CurveEngine.V5r3.Assets.Equity;
...
using Highlander.CurveEngine.V5r3.Assets.Commodities;
using Highlander.CurveEngine.V5r3.Assets.Commodities.Futures;
using Highlander.CurveEngine.V5r3.Assets.Commodities.Spreads;
using Highlander.CurveEngine.V5r3.Assets.Commodities.Swaps;
using Highlander.CurveEngine.V5r3.Assets.FX;
using Highlander.CurveEngine.V5r3.Assets.FX.Cash;
using Highlander.CurveEngine.V5r3.Assets.Inflation.Index;
using Highlander.CurveEngine.V5r3.Assets.Inflation.Swaps;
using Highlander.CurveEngine.V5r3.Assets.Options;
using Highlander.CurveEngine.V5r3.Assets.Property.Lease;
...
using MarketQuoteHelper = Highlander.CurveEngine.V5r3.Helpers.MarketQuoteHelper;
    ...
    public class PriceableAssetFactory
    {
            ...
            if (instrument != null)
            {
                try
                {
                    ...
                    if (instrument.InstrumentNodeItem is BasisSwapNodeStruct nodeStruct)
                    {
                        ...
                        //Invert the quote if the margin leg is not the index tenor.
            ...
            IBusinessCalendar fixingCalendar, IBusinessCalendar rollCalendar)
        {
            ...
            foreach (var assetIdentifier in uniqueIds.Distinct())
            {
                ...
                //Not efficient, but the spread Fra needs to be excluded now they implement the IPriceableRateAssetController interface.
            ...
            IBusinessCalendar fixingCalendar, IBusinessCalendar rollCalendar)
        {
            ...
            //2.    If there are, derive the outright from the cached spot rate and the forward points.
            foreach (var asset in quotedAssetSet.instrumentSet.Items)
            {
