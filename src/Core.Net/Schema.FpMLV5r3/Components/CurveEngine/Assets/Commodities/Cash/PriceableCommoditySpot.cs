...
namespace Highlander.CurveEngine.V5r3.Assets.Commodities.Cash
{
    ///<summary>
    ///</summary>
    public class PriceableCommoditySpot : PriceableCommodityAssetController
    {
        ///<summary>
        ///</summary>
        ...
        public BasicQuotation CommodityIndex => CommodityValue;
