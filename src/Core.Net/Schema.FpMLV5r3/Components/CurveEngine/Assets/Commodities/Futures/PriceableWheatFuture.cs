...
namespace Highlander.CurveEngine.V5r3.Assets.Commodities.Futures
{
    ...
    /// </summary>
    public class PriceableWheatFuture : PriceableCommodityFuturesAsset
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceableCommodityFuturesAsset"/> class.
        /// </summary>
        /// <param name="baseDate">The base date.</param>
        /// <param name="nodeStruct">The nodeStruct.</param>
        /// <param name="rollCalendar">THe rollCalendar.</param>
        /// <param name="fixedRate"></param>
        public PriceableWheatFuture(DateTime baseDate, CommodityFutureNodeStruct nodeStruct,
            ...
            })
        {
            ...
            LastTradeDate = rollCalendar.Advance(lastTradingDay.GetLastTradingDay(baseDate), RollOffset, BusinessDayConventionEnum.PRECEDING);
