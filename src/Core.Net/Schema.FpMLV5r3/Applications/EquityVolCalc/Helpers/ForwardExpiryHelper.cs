...
namespace Highlander.Equity.Calculator.V5r3.Helpers
{
    ...
    public static class ForwardExpiryHelper
    {
        ...
        internal static void GroupStrikesByMoneyness(decimal forwardPrice, List<EquityStrike> strikes, List<double> rawStrikePrices, ref List<EquityStrike> strikesLessThanFwd, ref List<EquityStrike> strikesEqualToFwd, ref  List<EquityStrike> strikesGreaterThanFwd)
        {
        ...
        {
            var inTheMoney = new List<EquityStrike>();
            var atTheMoney = new List<EquityStrike>();
            var outTheMoney = new List<EquityStrike>();
            GroupStrikesByMoneyness(expiry.FwdPrice, new List<EquityStrike>(expiry.Strikes), expiry.RawStrikePrices, ref inTheMoney, ref atTheMoney, ref outTheMoney);
        }
        ...
        public static ForwardExpiry FindExpiryClosestTo(ForwardExpiry fwdExpiry, VolatilitySurface volSurface, int proximityDays)
        {
            ...
            foreach (ForwardExpiry childExpiry in volSurface.Expiry)
            {
