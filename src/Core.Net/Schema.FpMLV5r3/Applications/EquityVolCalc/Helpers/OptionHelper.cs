...
using System;
using Highlander.Equity.Calculator.V5r3.Pricing;
...
namespace Highlander.Equity.Calculator.V5r3.Helpers
{
    ...
    public static class OptionHelper
    {
        ...
        /// <returns></returns>
        public static double GetImpliedVol(Stock stock, DateTime exp, double volGuess, double strike, bool call, string style, double premium, int gridSteps)
        {
            ...
            double vol0 = option.OptSolveVol(premium, fwd);
            return vol0;
        }
        ...
        /// <param name="gridSteps">The grid steps.</param>
        /// <returns></returns>
        public static double GetImpliedVol(Stock stock, DateTime exp, double strike, bool call, string style, double premium, int gridSteps)
        {
            DateTime date0 = stock.Date;
            DateTime exp0 = exp;
            double spot0 = Convert.ToDouble(stock.Spot);
