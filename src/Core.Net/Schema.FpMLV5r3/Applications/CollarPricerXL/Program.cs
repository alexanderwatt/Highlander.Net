...
namespace Highlander.CollarPricerXL.Test.V5r3
{
    class Program
    {
        static void Main(string[] args)
        {
          ...
          var ist = new SimpleStock("BHP", "BHP", dList, wc) {Transaction = tr};
          ...
          var ist2 = new SimpleStock("BHP", "BHP", dList2, wc2) {Transaction = tr2};
          //set up the zero curve
          ...
          //test collar
          var testSt3 = new Strike(OptionType.Call, 5379.10);
          ist2.Transaction.SetStrike(testSt2);
          price = col2.FindZeroCostPutStrike(ist2, zc2);
          var testSt4 = new Strike(OptionType.Put, 3900.00);
