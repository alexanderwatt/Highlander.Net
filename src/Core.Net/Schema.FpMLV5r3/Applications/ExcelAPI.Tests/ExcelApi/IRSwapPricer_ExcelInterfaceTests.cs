...
namespace Highlander.Excel.Tests.V5r3.ExcelApi
{
    ...
    {       
        ...
        public void GetDetailedCashflowsOverFlowExceptionError()//found on 16.01.2008
        {
            ...
            CalculationPeriod calculationPeriod0 = Highlander.Reporting.Helpers.V5r3.XsdClassesFieldResolver.GetPaymentCalculationPeriodCalculationPeriodArray(cashflows.paymentCalculationPeriod[0])[0];
            CalculationPeriod calculationPeriod1 = Highlander.Reporting.Helpers.V5r3.XsdClassesFieldResolver.GetPaymentCalculationPeriodCalculationPeriodArray(cashflows.paymentCalculationPeriod[1])[0];
