...
namespace Highlander.Excel.Tests.V5r3.ExcelApi
{
    ...
    {       
        ...
        public void Vanilla()
        {
            ...
            //
            string valReportAsString = irSwapPricer.Save2(Engine.Logger, Engine.Cache, Engine.NameSpace, ExcelAPITests.CreateValuationSetList2(12345.67, -0.321), valuationRange, tradeRange,
            ...
            foreach(bool fromPayerTail in new[]{true, false})
            {
                foreach(bool fromReceiverTail in new[]{true, false})
                {
                    foreach (ModifyNotionalCashflowsResult result in inputAndOutput)
                    {
                        ...
                        string valReportAsString1 = irSwapPricer.Save2(Engine.Logger, Engine.Cache, Engine.NameSpace, ExcelAPITests.CreateValuationSetList2(12345.67, -0.321), valuationRange, tradeRange,
                                                                        payFixed, null, receiveFloat, null,
                        ...
                        string valReportAsString2 = irSwapPricer.Save2(Engine.Logger, Engine.Cache, Engine.NameSpace, ExcelAPITests.CreateValuationSetList2(12345.67, -0.321), valuationRange, tradeRange,
                                                                       payFixed, null, receiveFloat, null,
