...
{
    internal class InternalPortfolioRevaluationRequest
    {
        ...
        public InternalPortfolioRevaluationRequest(Guid requestId, HandlerResponse pvRes)
        {
            RequestId = requestId;
        ...
        public InternalPortfolioRevaluationRequest(Guid requestId, DateTimeOffset created, PortfolioValuationRequest pvReq)
        {
            RequestId = requestId;
            Created = created;
            Request = pvReq;
        ...
        public InternalPortfolioRevaluationRequest(Guid requestId, DateTimeOffset created)
        {
            RequestId = requestId;
            Created = created;
            LatestResult = new HandlerResponse
    ...
    public class PortfolioValuationServer : ServerBase2
    {
        ...
        readonly Guarded<Dictionary<Guid, InternalPortfolioRevaluationRequest>> _outstandingRequests =
            new Guarded<Dictionary<Guid, InternalPortfolioRevaluationRequest>>(new Dictionary<Guid, InternalPortfolioRevaluationRequest>());
        ...
        private void ReceivePortfolioValuationResult(HandlerResponse pvResult)
        {
            ...
            {
                InternalPortfolioRevaluationRequest request;
                ...
                {
                    // not found
                    request = new InternalPortfolioRevaluationRequest(requestId, pvResult);
        ...
        private void ReceivePortfolioValuationRequest(ICoreItem item)
        {
            ...
            InternalPortfolioRevaluationRequest newRequest = null;
            _outstandingRequests.Locked(requests =>
            {
                InternalPortfolioRevaluationRequest oldRequest;
                if (!requests.TryGetValue(requestId, out oldRequest))
                {
                    // not found
                    newRequest = new InternalPortfolioRevaluationRequest(requestId, created);
                }
                if (newRequest != null)
                {
        ...
        private void ReceiveCancellationRequest(ICoreItem item)
        {
            ...
            InternalPortfolioRevaluationRequest internalRequest = null;
            _outstandingRequests.Locked(requests =>
            {
        ...
        private void DequeueWorkerRequests(object notUsed)
        {
            ...
            try
            {
                ...
                {
                    workToDo = false;
                    InternalPortfolioRevaluationRequest activeRequest = null;
                    DateTimeOffset oldestRequestCreated = DateTimeOffset.MaxValue;
                    _outstandingRequests.Locked(requests =>
                    {
                        foreach (InternalPortfolioRevaluationRequest request in requests.Values)
                        {
