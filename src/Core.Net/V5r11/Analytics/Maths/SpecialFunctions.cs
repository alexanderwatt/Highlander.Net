...
namespace Highlander.Reporting.Analytics.V5r3.Maths
{
    /// <summary>
    ...
    public static class Fn
    {
        ...
        {
            if (value < 0)
                throw new ArgumentOutOfRangeException(nameof(value), "ArgumentPositive");
            if (value <= 1)
                return 0.0d;
            if (value >= FactorialLnCacheSize)
                return GammaLn(value + 1.0);
            if (_factorialLnCache == null)
                _factorialLnCache = new double[FactorialLnCacheSize];
            return _factorialLnCache[value] != 0.0 ? _factorialLnCache[value]
                       : (_factorialLnCache[value] = GammaLn(value + 1.0));
        }
        private static double[] _factorialLnCache;
        ...
        public static double Factorial(int value)
        {
            ...
            if (_factorialPrecomp == null)
                _factorialPrecomp = new[]
            ...
            return _factorialPrecomp[value];
        }
        private static double[] _factorialPrecomp;
        ...
        {
            double x, y;
            double[] coefficient = {76.18009172947146,-86.50535032941677,
        ...
        public static double IncompleteGammaRegularized(double a, double x)
        {
            ...
            if (a < 0.0 || x < 0.0)
                throw new ArgumentOutOfRangeException(nameof(a), "ArgumentNotNegative");
            ...
            throw new ArgumentException("ArgumentTooLargeForIterationLimit");
        }
        #endregion
        ...
        public static double IncompleteBetaRegularized(double a, double b, double x)
        {
            if (a < 0.0 || b < 0.0)
                throw new ArgumentOutOfRangeException(nameof(a), "ArgumentNotNegative");
            if (x < 0.0 || x > 1.0)
                throw new ArgumentOutOfRangeException(nameof(x), String.Format("ArgumentInIntervalXYInclusive"));
        ...
        public static double ErfInverse(double x)
        {
            if (x < -1.0 || x > 1.0) throw new ArgumentOutOfRangeException(
                 nameof(x), x, String.Format("ArgumentInIntervalXYInclusive"));
            x = 0.5 * (x + 1.0);
            // Define break-points.
            double plow = 0.02425;
            double phigh = 1 - plow;
        ...
        private static readonly double[] ErfinvA = {-3.969683028665376e+01, 2.209460984245205e+02,
                                            -2.759285104469687e+02, 1.383577518672690e+02,
                                            -3.066479806614716e+01, 2.506628277459239e+00};

        private static readonly double[] ErfinvB = {-5.447609879822406e+01, 1.615858368580409e+02,
                                            -1.556989798598866e+02, 6.680131188771972e+01, -1.328068155288572e+01};

        private static readonly double[] ErfinvC = {-7.784894002430293e-03, -3.223964580411365e-01,
                                            -2.400758277161838e+00, -2.549732539343734e+00,
                                            4.374664141464968e+00, 2.938163982698783e+00};

        private static readonly double[] ErfinvD = {7.784695709041462e-03, 3.224671290700398e-01,
