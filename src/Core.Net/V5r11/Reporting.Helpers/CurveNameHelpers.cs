...
{
    internal class CurveNameHelpers
    {
        #region Helpers
        ...
        {
            AdjustableDate adjustableEffectiveDate = Reporting.XsdClassesFieldResolver.CalculationPeriodDatesGetEffectiveDate(swap.swapStream[0].calculationPeriodDates);
            AdjustableDate adjustableTerminationDate = Reporting.XsdClassesFieldResolver.CalculationPeriodDatesGetTerminationDate(swap.swapStream[0].calculationPeriodDates);
            ...
            var notional = Reporting.XsdClassesFieldResolver.CalculationGetNotionalSchedule(calculation);
