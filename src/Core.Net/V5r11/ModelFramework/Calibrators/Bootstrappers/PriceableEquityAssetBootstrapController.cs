...
namespace Orion.ModelFramework.Calibrators.Bootstrappers
{
    ...
    /// 
    /// </summary>
    abstract public class PriceableEquityAssetBootstrapController : IBootstrapPriceableEquityAssetController<IBootstrapControllerData, IPricingStructure>
    {
        ///<summary>
        ///</summary>
        protected PriceableEquityAssetBootstrapController()
        {
            Id = string.Empty;
        }
        ...
        /// <returns></returns>
        abstract public IPricingStructure Calculate(IBootstrapControllerData bootstrapData, IPriceableEquityAssetController[] priceableAssets);
        ...
        /// <returns></returns>
        protected static IEquityCurve GetValue<T>(T bootstrapResults)
        {
            return (IEquityCurve)ObjectLookupHelper.GetPropertyValue(bootstrapResults, "PricingStructure");
        }
