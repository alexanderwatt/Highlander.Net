...
namespace nab.QDS.FpML.V47
{
    public partial class FxLeg
    {
        ...
        public static FxLeg CreateForward(string exchangeCurrency1PayPartyReference, string exchangeCurrency2PayPartyReference,
        ...
        public static FxLeg CreateSpot(string exchangeCurrency1PayPartyReference, string exchangeCurrency2PayPartyReference, decimal exchangeCurrency1Amount,
