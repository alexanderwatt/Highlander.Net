...
namespace Highlander.Configuration.Data.V5r3
{
    public static class ConfigDataLoader
    {
        ...
        private static ItemInfo StandardConfigProps(string type, string idSuffix, string nameSpace)
        {
            ...
            itemProps.Set(EnvironmentProp.DataGroup, nameSpace + ".V5r3.Configuration." + type);
        ...
        public static void LoadInstrumentsConfig(ILogger logger, ICoreCache targetClient, string nameSpace)
        {
            ...
            const string name = "Highlander.Configuration.Data.V5r3.Config.Instruments.xml";
        ...
        private static ItemInfo HolidayDatesConfigProps(LocationCalendarYear locationCalendarYear, string nameSpace)
        {
            ...
            itemProps.Set(EnvironmentProp.DataGroup, nameSpace + ".ReferenceData.RDMHolidays");
            itemProps.Set(EnvironmentProp.SourceSystem, "Highlander");
            itemProps.Set(EnvironmentProp.Function, FunctionProp.Configuration.ToString());
        ...
        private static ItemInfo BusinessCenterHolidayConfigProps(BusinessCenterCalendar locationCalendarYear, string nameSpace)
        {
            ...
            itemProps.Set(EnvironmentProp.DataGroup, nameSpace + ".ReferenceData.BusinessCenterHolidays");
            itemProps.Set(EnvironmentProp.SourceSystem, "Highlander");
        ...
        {
            Assembly assembly = Assembly.GetExecutingAssembly();
            const string name = "Highlander.Configuration.Data.V5r3.Config.PricingStructureAlgorithms.xml";
            var xml = ResourceHelper.GetResource(assembly, name);
        ...
        {
            Assembly assembly = Assembly.GetExecutingAssembly();
            var prefix = "Highlander.Configuration.Data.V5r3.Config.HolidayDates";
        ...
        {
            Assembly assembly = Assembly.GetExecutingAssembly();
            var prefix = "Highlander.Configuration.Data.V5r3.Config.DateRules";
            Dictionary<string, string> chosenFiles = ResourceHelper.GetResources(assembly, prefix, "xml");
            if (chosenFiles.Count == 0) throw new InvalidOperationException("Missing Date Rules");
        ...
        {
            string xml = GetXml("Highlander.Configuration.Data.V5r3.Config.GwmlEnumMaps.xml");
        ...
        {
            Assembly assembly = Assembly.GetExecutingAssembly();
            var prefix = "Highlander.Configuration.Data.V5r3.Config.FpMLCodes";
            Dictionary<string, string> chosenFiles = ResourceHelper.GetResources(assembly, prefix, "xml");
            ...
            foreach (var file in chosenFiles)
            {
                ...
                scheme.GetItemProps().Set(EnvironmentProp.DataGroup, nameSpace + ".Configuration." + type);
                scheme.GetItemProps().Set(EnvironmentProp.SourceSystem, "Highlander");
